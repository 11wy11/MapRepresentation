...
#include "../../../../../../../../src/gui/codeeditors/qgscodeeditorexpression.h"
...
QT_INIT_METAOBJECT const QMetaObject QgsCodeEditorExpression::staticMetaObject = {
...
QT_INIT_METAOBJECT const QMetaObject QgsLexerExpression::staticMetaObject = {
...
struct qt_meta_stringdata_QgsSciApisExpression_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QgsSciApisExpression_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QgsSciApisExpression_t qt_meta_stringdata_QgsSciApisExpression = {
    {
QT_MOC_LITERAL(0, 0, 20) // "QgsSciApisExpression"
...
static const uint qt_meta_data_QgsSciApisExpression[] = {
...
void QgsSciApisExpression::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject QgsSciApisExpression::staticMetaObject = {
    { &QsciAPIs::staticMetaObject, qt_meta_stringdata_QgsSciApisExpression.data,
      qt_meta_data_QgsSciApisExpression,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *QgsSciApisExpression::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *QgsSciApisExpression::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_QgsSciApisExpression.stringdata0))
        return static_cast<void*>(this);
    return QsciAPIs::qt_metacast(_clname);
}

int QgsSciApisExpression::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
