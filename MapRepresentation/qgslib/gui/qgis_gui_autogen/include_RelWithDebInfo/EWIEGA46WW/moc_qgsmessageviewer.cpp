...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsMessageViewer_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 17, 16), // "checkBox_toggled"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "QgsMessageViewer\0checkBox_toggled\0"
};
...
QT_INIT_METAOBJECT const QMetaObject QgsMessageViewer::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QgsMessageViewer.data,
      qt_meta_data_QgsMessageViewer,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsMessageViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMessageViewer.stringdata0))
