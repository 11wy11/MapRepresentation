...
#include "../../../../../../../../src/gui/qgsmessagebar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QgsMessageBar_t, stringdata0) + ofs \
...
void QgsMessageBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (QgsMessageBar::*)(QgsMessageBarItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsMessageBar::widgetAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QgsMessageBar::*)(QgsMessageBarItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QgsMessageBar::widgetRemoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QgsMessageBar::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QgsMessageBar.data,
      qt_meta_data_QgsMessageBar,  qt_static_metacall, nullptr, nullptr}
};
...
void *QgsMessageBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QgsMessageBar.stringdata0))
