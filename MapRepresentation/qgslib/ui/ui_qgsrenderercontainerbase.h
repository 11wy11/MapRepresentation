...
public:
    ...
    void retranslateUi(QWidget *QgsRendererWidgetContainerBase)
    {
        ...
        mBackButton->setToolTip(QApplication::translate("QgsRendererWidgetContainerBase", "Go back", nullptr));
#endif // QT_NO_TOOLTIP
        mBackButton->setText(QString());
        mTitleText->setText(QString());
#ifndef QT_NO_TOOLTIP
        mMenuButton->setToolTip(QApplication::translate("QgsRendererWidgetContainerBase", "Go back", nullptr));
#endif // QT_NO_TOOLTIP
