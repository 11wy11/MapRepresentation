...
public:
    ...
    {
        QgsLayoutAtlasWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutAtlasWidgetBase", "Atlas Generation", nullptr));
        mUseAtlasCheckBox->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Generate an atlas", nullptr));
        mConfigurationGroup->setTitle(QApplication::translate("QgsLayoutAtlasWidgetBase", "Configuration", nullptr));
#ifndef QT_NO_TOOLTIP
        mAtlasSortFeatureDirectionButton->setToolTip(QApplication::translate("QgsLayoutAtlasWidgetBase", "Sort direction", nullptr));
#endif // QT_NO_TOOLTIP
        mAtlasSortFeatureDirectionButton->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "\342\200\246", nullptr));
        mAtlasFeatureFilterCheckBox->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Filter with", nullptr));
        mAtlasFeatureFilterButton->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "\342\200\246", nullptr));
        mAtlasHideCoverageCheckBox->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Hidden coverage layer", nullptr));
        mHorizontalAlignementLabel->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Coverage layer", nullptr));
        label->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Page name", nullptr));
        mAtlasSortFeatureCheckBox->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Sort by", nullptr));
        mOutputGroup->setTitle(QApplication::translate("QgsLayoutAtlasWidgetBase", "Output", nullptr));
        mAtlasFilenameExpressionButton->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "\342\200\246", nullptr));
        mAtlasSingleFileCheckBox->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Single file export when possible", nullptr));
        mFileFormatLabel->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Image export format", nullptr));
        label_4->setText(QApplication::translate("QgsLayoutAtlasWidgetBase", "Output filename expression", nullptr));
    } // retranslateUi
