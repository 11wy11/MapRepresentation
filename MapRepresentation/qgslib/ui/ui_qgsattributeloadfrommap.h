...
public:
    ...
    {
        QgsAttributeLoadValues->setWindowTitle(QApplication::translate("QgsAttributeLoadValues", "Load Values from Layer", nullptr));
        layerLabel->setText(QApplication::translate("QgsAttributeLoadValues", "Layer", nullptr));
        keyLabel->setText(QApplication::translate("QgsAttributeLoadValues", "Description", nullptr));
        QTableWidgetItem *___qtablewidgetitem = previewTableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsAttributeLoadValues", "Value", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = previewTableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsAttributeLoadValues", "Description", nullptr));
        valueTableLabel->setText(QApplication::translate("QgsAttributeLoadValues", "Select data from attributes in selected layer.", nullptr));
        valueLabel->setText(QApplication::translate("QgsAttributeLoadValues", "Value", nullptr));
        previewButton->setText(QApplication::translate("QgsAttributeLoadValues", "View All", nullptr));
        nullCheckBox->setText(QApplication::translate("QgsAttributeLoadValues", "Insert NULL value on top", nullptr));
    } // retranslateUi
