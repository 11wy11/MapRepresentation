...
public:
    ...
    {
        QgsProjectLayerGroupDialogBase->setWindowTitle(QApplication::translate("QgsProjectLayerGroupDialogBase", "Select Layers and Groups to Embed", nullptr));
        mProjectFileLabel->setText(QApplication::translate("QgsProjectLayerGroupDialogBase", "Project file", nullptr));
    } // retranslateUi
