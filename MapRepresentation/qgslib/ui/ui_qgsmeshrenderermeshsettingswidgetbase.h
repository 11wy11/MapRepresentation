...
public:
    ...
    {
        mLineWidthLabel->setText(QApplication::translate("QgsMeshRendererMeshSettingsWidgetBase", "Line width", nullptr));
        label_2->setText(QApplication::translate("QgsMeshRendererMeshSettingsWidgetBase", "Line color", nullptr));
