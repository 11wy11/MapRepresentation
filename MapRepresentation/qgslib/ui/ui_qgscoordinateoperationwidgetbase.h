...
public:
    ...
    {
        QgsCoordinateOperationWidgetBase->setWindowTitle(QApplication::translate("QgsCoordinateOperationWidgetBase", "Select Datum Transformations", nullptr));
        mInstallGridButton->setText(QApplication::translate("QgsCoordinateOperationWidgetBase", "Install Grid\342\200\246", nullptr));
        mHideDeprecatedCheckBox->setText(QApplication::translate("QgsCoordinateOperationWidgetBase", "Hide deprecated transformations", nullptr));
        mShowSupersededCheckBox->setText(QApplication::translate("QgsCoordinateOperationWidgetBase", "Show superseded transforms", nullptr));
...
#endif // QT_NO_TOOLTIP
        mAllowFallbackCheckBox->setText(QApplication::translate("QgsCoordinateOperationWidgetBase", "Allow fallback transforms if preferred operation fails", nullptr));
#ifndef QT_NO_TOOLTIP
        mMakeDefaultCheckBox->setToolTip(QApplication::translate("QgsCoordinateOperationWidgetBase", "If checked, the selected transformation will become the default choice in all new projects", nullptr));
#endif // QT_NO_TOOLTIP
        mMakeDefaultCheckBox->setText(QApplication::translate("QgsCoordinateOperationWidgetBase", "Make default", nullptr));
    } // retranslateUi
