...
public:
    ...
    {
        QgsSmartGroupEditorDialogBase->setWindowTitle(QApplication::translate("QgsSmartGroupEditorDialogBase", "Smart Group Editor", nullptr));
        label->setText(QApplication::translate("QgsSmartGroupEditorDialogBase", "Smart group name", nullptr));
        label_2->setText(QApplication::translate("QgsSmartGroupEditorDialogBase", "Condition matches", nullptr));
        mAddConditionBtn->setText(QApplication::translate("QgsSmartGroupEditorDialogBase", "Add Condition", nullptr));
        mConditionsBox->setTitle(QApplication::translate("QgsSmartGroupEditorDialogBase", "Conditions", nullptr));
    } // retranslateUi
