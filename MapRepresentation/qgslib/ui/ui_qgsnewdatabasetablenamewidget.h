...
public:
    ...
    {
        mActionRefresh->setText(QApplication::translate("QgsNewDatabaseTableNameWidget", "Refresh", nullptr));
        mNewTableName->setText(QString());
        mNewTableName->setPlaceholderText(QApplication::translate("QgsNewDatabaseTableNameWidget", "name of the new table", nullptr));
        mOkButton->setText(QApplication::translate("QgsNewDatabaseTableNameWidget", "Ok", nullptr));
        label->setText(QApplication::translate("QgsNewDatabaseTableNameWidget", "New table name", nullptr));
        mValidationResults->setText(QApplication::translate("QgsNewDatabaseTableNameWidget", "Validation results", nullptr));
