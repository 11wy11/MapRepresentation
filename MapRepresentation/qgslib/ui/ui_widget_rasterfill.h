...
public:
    ...
    void setupUi(QWidget *WidgetRasterFill)
    {
        ...
        mWidthSpinBox->setMaximum(1e+08);
    ...
    {
        mRotationDDBtn->setText(QApplication::translate("WidgetRasterFill", "\342\200\246", nullptr));
        mWidthDDBtn->setText(QApplication::translate("WidgetRasterFill", "\342\200\246", nullptr));
        cboCoordinateMode->setItemText(0, QApplication::translate("WidgetRasterFill", "Object", nullptr));
        cboCoordinateMode->setItemText(1, QApplication::translate("WidgetRasterFill", "Viewport", nullptr));

        mLabelImagePreview->setText(QString());
        mRotationSpinBox->setSuffix(QApplication::translate("WidgetRasterFill", " \302\260", nullptr));
        mWidthSpinBox->setSpecialValueText(QApplication::translate("WidgetRasterFill", "Original", nullptr));
        mFilenameDDBtn->setText(QApplication::translate("WidgetRasterFill", "\342\200\246", nullptr));
        mOpacityDDBtn->setText(QApplication::translate("WidgetRasterFill", "\342\200\246", nullptr));
        label_2->setText(QApplication::translate("WidgetRasterFill", "x", nullptr));
        label_4->setText(QApplication::translate("WidgetRasterFill", "y", nullptr));
        label_7->setText(QApplication::translate("WidgetRasterFill", "Offset", nullptr));
        mRotationLabel->setText(QApplication::translate("WidgetRasterFill", "Rotation", nullptr));
        label->setText(QApplication::translate("WidgetRasterFill", "Opacity", nullptr));
        label_3->setText(QApplication::translate("WidgetRasterFill", "Coord mode", nullptr));
        mTextureWidthLabel->setText(QApplication::translate("WidgetRasterFill", "Image width", nullptr));
        mOffsetDDBtn->setText(QApplication::translate("WidgetRasterFill", "\342\200\246", nullptr));
