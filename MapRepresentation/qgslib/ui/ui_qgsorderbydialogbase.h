...
public:
    ...
    {
        OrderByDialogBase->setWindowTitle(QApplication::translate("OrderByDialogBase", "Define Order", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mOrderByTableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("OrderByDialogBase", "Expression", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mOrderByTableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("OrderByDialogBase", "Asc / Desc", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mOrderByTableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("OrderByDialogBase", "NULLs handling", nullptr));
    } // retranslateUi
