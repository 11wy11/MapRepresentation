...
public:
    ...
    {
        QgsAnimationExportDialogBase->setWindowTitle(QApplication::translate("QgsAnimationExportDialogBase", "Export Map Animation", nullptr));
        mOutputDirLabel_2->setText(QApplication::translate("QgsAnimationExportDialogBase", "Output directory", nullptr));
        groupBox->setTitle(QApplication::translate("QgsAnimationExportDialogBase", "Temporal Settings", nullptr));
        label_6->setText(QApplication::translate("QgsAnimationExportDialogBase", "Range", nullptr));
        mEndDateTime->setDisplayFormat(QApplication::translate("QgsAnimationExportDialogBase", "M/d/yyyy h:mm AP", nullptr));
        label_5->setText(QApplication::translate("QgsAnimationExportDialogBase", "to ", nullptr));
        mStartDateTime->setDisplayFormat(QApplication::translate("QgsAnimationExportDialogBase", "M/d/yyyy h:mm AP", nullptr));
        mSetToProjectTimeButton->setText(QString());
        label_2->setText(QApplication::translate("QgsAnimationExportDialogBase", "Step (frame length)", nullptr));
        mTimeStepsComboBox->setCurrentText(QString());
        mTemplateLabel_2->setText(QApplication::translate("QgsAnimationExportDialogBase", "Template", nullptr));
#ifndef QT_NO_TOOLTIP
        mTemplateLineEdit->setToolTip(QApplication::translate("QgsAnimationExportDialogBase", "Number of # represents number of digits (e.g. frame###.png -> frame001.png)", nullptr));
#endif // QT_NO_TOOLTIP
        groupBox_2->setTitle(QApplication::translate("QgsAnimationExportDialogBase", "Map Settings", nullptr));
        label_3->setText(QApplication::translate("QgsAnimationExportDialogBase", "Output width", nullptr));
        mOutputHeightSpinBox->setSuffix(QApplication::translate("QgsAnimationExportDialogBase", " px", nullptr));
        mOutputHeightSpinBox->setPrefix(QString());
        mOutputWidthSpinBox->setSuffix(QApplication::translate("QgsAnimationExportDialogBase", " px", nullptr));
        mOutputWidthSpinBox->setPrefix(QString());
#ifndef QT_NO_TOOLTIP
        mLockAspectRatio->setToolTip(QApplication::translate("QgsAnimationExportDialogBase", "Lock aspect ratio (including while drawing extent onto canvas)", nullptr));
#endif // QT_NO_TOOLTIP
        mExtentGroupBox->setTitle(QApplication::translate("QgsAnimationExportDialogBase", "Extent", nullptr));
        label_4->setText(QApplication::translate("QgsAnimationExportDialogBase", "Output height", nullptr));
        mDrawDecorations->setText(QApplication::translate("QgsAnimationExportDialogBase", "Draw active decorations", nullptr));
    } // retranslateUi
