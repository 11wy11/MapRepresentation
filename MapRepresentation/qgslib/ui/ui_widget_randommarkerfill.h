...
public:
    ...
    void setupUi(QWidget *WidgetRandomMarkerFill)
    {
        ...
        mDensityAreaSpinBox->setMaximum(1e+08);
    ...
    {
        mCountMethodLabel->setText(QApplication::translate("WidgetRandomMarkerFill", "Count method", nullptr));
        mSeedDdbtn->setText(QApplication::translate("WidgetRandomMarkerFill", "\342\200\246", nullptr));
        label->setText(QApplication::translate("WidgetRandomMarkerFill", "Seed", nullptr));
        mPointCountLabel->setText(QApplication::translate("WidgetRandomMarkerFill", "Point count", nullptr));
        mDensityAreaLabel->setText(QApplication::translate("WidgetRandomMarkerFill", "Density area", nullptr));
        mDensityAreaDdbtn->setText(QApplication::translate("WidgetRandomMarkerFill", "\342\200\246", nullptr));
        mSeedSpinBox->setSpecialValueText(QApplication::translate("WidgetRandomMarkerFill", "randomised", nullptr));
        mPointCountDdbtn->setText(QApplication::translate("WidgetRandomMarkerFill", "\342\200\246", nullptr));
        mClipPointsCheckBox->setText(QApplication::translate("WidgetRandomMarkerFill", "Clip markers to polygon boundary", nullptr));
        mClipPointsDdbtn->setText(QApplication::translate("WidgetRandomMarkerFill", "\342\200\246", nullptr));
