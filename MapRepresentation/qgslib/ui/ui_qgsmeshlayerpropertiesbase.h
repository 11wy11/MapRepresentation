...
public:
    ...
    void setupUi(QDialog *QgsMeshLayerPropertiesBase)
    {
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/themes/default/propertyicons/editmetadata.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 470, 383));
...
"border-radius: 2px;"));
        ...
        mOptsPage_StyleContent->setGeometry(QRect(0, 0, 100, 30));
        ...
        mSimplifyReductionFactorSpinBox->setMaximum(1e+06);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/images/themes/default/mActionRefresh.svg"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    {
        QgsMeshLayerPropertiesBase->setWindowTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Raster Layer Properties", nullptr));
        ...
        ___qlistwidgetitem->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Information", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Information", nullptr));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem1 = mOptionsListWidget->item(1);
        ___qlistwidgetitem1->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Source", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem1->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Source", nullptr));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem2 = mOptionsListWidget->item(2);
        ___qlistwidgetitem2->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Symbology", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem2->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Symbology", nullptr));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem3 = mOptionsListWidget->item(3);
        ___qlistwidgetitem3->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Rendering", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem3->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Rendering", nullptr));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem4 = mOptionsListWidget->item(4);
        ___qlistwidgetitem4->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Temporal", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem4->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Temporal Settings", nullptr));
#endif // QT_NO_TOOLTIP
        QListWidgetItem *___qlistwidgetitem5 = mOptionsListWidget->item(5);
        ___qlistwidgetitem5->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Metadata", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qlistwidgetitem5->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Metadata", nullptr));
#endif // QT_NO_TOOLTIP
        mOptionsListWidget->setSortingEnabled(__sortingEnabled);

        groupBox_60->setTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Settings", nullptr));
        label_7->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Layer name", nullptr));
        label_13->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "displayed as", nullptr));
        mCrsGroupBox->setTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Assigned Coordinate Reference System (CRS)", nullptr));
        label_11->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "<html><head/><body><p><span style=\" font-weight:600;\">Changing this option does not modify the original data source or perform any reprojection of the mesh. Rather, it can be used to override the layer's CRS within this project if it could not be detected or has been incorrectly detected.</span></p></body></html>", nullptr));
#ifndef QT_NO_TOOLTIP
        mTemporalStaticDatasetCheckBox->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Static dataset even if the temporal navigation is on", nullptr));
#endif // QT_NO_TOOLTIP
        mTemporalStaticDatasetCheckBox->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Always treat as a static dataset, regardless of temporal properties", nullptr));
        mStaticDatasetGroupBox->setTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Static Dataset", nullptr));
        mSimplifyMeshGroupBox->setTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Simplify Mesh", nullptr));
        label_5->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Reduction factor", nullptr));
        label_2->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Maximal mesh resolution", nullptr));
        mSimplifyMeshResolutionSpinBox->setSuffix(QApplication::translate("QgsMeshLayerPropertiesBase", " pixels/triangle", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Provider Time Settings", nullptr));
        label_12->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Time unit", nullptr));
#ifndef QT_NO_TOOLTIP
        mTemporalProviderTimeUnitComboBox->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Default time unit of mesh data provider is hour, change to override the time unit", nullptr));
#endif // QT_NO_TOOLTIP
        groupBox->setTitle(QApplication::translate("QgsMeshLayerPropertiesBase", "Layer Temporal Settings", nullptr));
        label_3->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Reference time", nullptr));
#ifndef QT_NO_TOOLTIP
        mTemporalDateTimeReference->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Reference time used to render mesh dataset when using temporal range or temporal animation", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mTemporalReloadButton->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Reload from provider", nullptr));
#endif // QT_NO_TOOLTIP
        mTemporalReloadButton->setText(QString());
        label_6->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Start time", nullptr));
        label_4->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "End time", nullptr));
        label_10->setText(QApplication::translate("QgsMeshLayerPropertiesBase", "Dataset matching method", nullptr));
#ifndef QT_NO_TOOLTIP
        mComboBoxTemporalDatasetMatchingMethod->setToolTip(QApplication::translate("QgsMeshLayerPropertiesBase", "Method for selection of temporal mesh dataset from a range time", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
