...
public:
    ...
    {
        label->setText(QApplication::translate("QgsProcessingFeatureSourceOptionsBase", "Invalid feature filtering", nullptr));
#ifndef QT_NO_TOOLTIP
        mComboInvalidFeatureFiltering->setToolTip(QApplication::translate("QgsProcessingFeatureSourceOptionsBase", "If set, allows the default method for handling features with invalid geometries to be overridden", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mFeatureLimitSpinBox->setToolTip(QApplication::translate("QgsProcessingFeatureSourceOptionsBase", "If set, limits the maximum number of features which will be processed from this source", nullptr));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("QgsProcessingFeatureSourceOptionsBase", "Limit features processed", nullptr));
