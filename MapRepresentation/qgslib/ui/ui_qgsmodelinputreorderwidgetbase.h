...
public:
    ...
    void retranslateUi(QWidget *QgsModelInputReorderWidgetBase)
    {
        ...
        mButtonUp->setToolTip(QApplication::translate("QgsModelInputReorderWidgetBase", "Move up", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mButtonDown->setToolTip(QApplication::translate("QgsModelInputReorderWidgetBase", "Move down", nullptr));
#endif // QT_NO_TOOLTIP
