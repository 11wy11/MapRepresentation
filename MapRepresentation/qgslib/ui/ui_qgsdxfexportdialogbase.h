...
public:
    ...
    {
        QgsDxfExportDialogBase->setWindowTitle(QApplication::translate("QgsDxfExportDialogBase", "DXF Export", nullptr));
        mSymbologyModeLabel->setText(QApplication::translate("QgsDxfExportDialogBase", "Symbology mode", nullptr));
        mSaveAsLabel->setText(QApplication::translate("QgsDxfExportDialogBase", "Save as", nullptr));
        mSymbologyModeComboBox->setItemText(0, QApplication::translate("QgsDxfExportDialogBase", "No symbology", nullptr));
        mSymbologyModeComboBox->setItemText(1, QApplication::translate("QgsDxfExportDialogBase", "Feature symbology", nullptr));
        mSymbologyModeComboBox->setItemText(2, QApplication::translate("QgsDxfExportDialogBase", "Symbol layer symbology", nullptr));

        mSymbologyScaleLabel->setText(QApplication::translate("QgsDxfExportDialogBase", "Symbology scale", nullptr));
        label_3->setText(QApplication::translate("QgsDxfExportDialogBase", "CRS", nullptr));
        mSelectAllButton->setText(QApplication::translate("QgsDxfExportDialogBase", "Select All", nullptr));
        mDeselectAllButton->setText(QApplication::translate("QgsDxfExportDialogBase", "Deselect All", nullptr));
        label->setText(QApplication::translate("QgsDxfExportDialogBase", "Encoding", nullptr));
        mSymbologyScaleLabel_2->setText(QApplication::translate("QgsDxfExportDialogBase", "Map themes", nullptr));
        mMapExtentCheckBox->setText(QApplication::translate("QgsDxfExportDialogBase", "Export features intersecting the current map extent", nullptr));
        mLayerTitleAsName->setText(QApplication::translate("QgsDxfExportDialogBase", "Use layer title as name if set", nullptr));
        mForce2d->setText(QApplication::translate("QgsDxfExportDialogBase", "Force 2d output (eg. to support polyline width)", nullptr));
        mMTextCheckBox->setText(QApplication::translate("QgsDxfExportDialogBase", "Export labels as MTEXT elements", nullptr));
    } // retranslateUi
