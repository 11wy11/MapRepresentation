...
public:
    ...
    {
        QgsVectorLayerSaveAsDialogBase->setWindowTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Save Vector Layer as\342\200\246", nullptr));
        mCrsLabel->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "CRS", nullptr));
        label_2->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Format", nullptr));
        label->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "File name", nullptr));
        label_7->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Layer name", nullptr));
        label_4->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Encoding", nullptr));
        mSelectedOnly->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Save only selected features", nullptr));
        mAttributesSelection->setTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Select fields to export and their export options", nullptr));
        mSelectAllAttributes->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Select All", nullptr));
        mDeselectAllAttributes->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Deselect All", nullptr));
        mReplaceRawFieldValues->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Replace all selected raw field values by displayed values", nullptr));
        mSymbologyExportLabel->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Symbology export", nullptr));
        mScaleLabel->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Scale", nullptr));
        mGeometryGroupBox->setTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Geometry", nullptr));
        mSymbologyExportLabel_2->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Geometry type", nullptr));
        mForceMultiCheckBox->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Force multi-type", nullptr));
        mIncludeZCheckBox->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Include z-dimension", nullptr));
        mExtentGroupBox->setTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Extent", nullptr));
        mDatasourceOptionsGroupBox->setTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Datasource Options", nullptr));
        mLayerOptionsGroupBox->setTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Layer Options", nullptr));
        mOgrOptionsGroupBox->setTitle(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Custom Options", nullptr));
        label_5->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Data source", nullptr));
        label_6->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Layer", nullptr));
        mAddToCanvas->setText(QApplication::translate("QgsVectorLayerSaveAsDialogBase", "Add saved file to map", nullptr));
    } // retranslateUi
