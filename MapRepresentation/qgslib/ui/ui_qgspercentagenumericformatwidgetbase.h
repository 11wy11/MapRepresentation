...
public:
    ...
    {
        mShowPlusCheckBox->setText(QApplication::translate("QgsPercentageNumericFormatWidgetBase", "Show plus sign", nullptr));
        mShowThousandsCheckBox->setText(QApplication::translate("QgsPercentageNumericFormatWidgetBase", "Show thousands separator", nullptr));
        label->setText(QApplication::translate("QgsPercentageNumericFormatWidgetBase", "Decimal places", nullptr));
        mShowTrailingZerosCheckBox->setText(QApplication::translate("QgsPercentageNumericFormatWidgetBase", "Show trailing zeros", nullptr));
        label_2->setText(QApplication::translate("QgsPercentageNumericFormatWidgetBase", "Scaling", nullptr));
