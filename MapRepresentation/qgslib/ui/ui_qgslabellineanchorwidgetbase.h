...
public:
    ...
    {
        groupBox->setTitle(QApplication::translate("QgsLabelLineAnchorWidgetBase", "Label Anchoring", nullptr));
        label->setText(QApplication::translate("QgsLabelLineAnchorWidgetBase", "<b>Controls the position along the line which labels will be placed close to.</b>", nullptr));
        mLinePlacementDDBtn->setText(QApplication::translate("QgsLabelLineAnchorWidgetBase", "\342\200\246", nullptr));
        mCustomPlacementSpinBox->setSuffix(QApplication::translate("QgsLabelLineAnchorWidgetBase", " %", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsLabelLineAnchorWidgetBase", "Placement Behavior", nullptr));
        mAnchorTypeHintLabel->setText(QApplication::translate("QgsLabelLineAnchorWidgetBase", "Hint", nullptr));
