...
public:
    ...
    {
        QgsLayoutTableBackgroundDialog->setWindowTitle(QApplication::translate("QgsLayoutTableBackgroundDialog", "Table Background Colors", nullptr));
        mFirstRowCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "First row", nullptr));
        mHeaderRowCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Header row", nullptr));
        mLastRowColorButton->setText(QString());
        mEvenColumnsColorButton->setText(QString());
        mEvenColumnsCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Even columns", nullptr));
        mFirstColumnCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "First column", nullptr));
        mEvenRowsCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Even rows", nullptr));
        mOddColumnsColorButton->setText(QString());
        mHeaderRowColorButton->setText(QString());
        mOddColumnsCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Odd columns", nullptr));
        mLastRowCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Last row", nullptr));
        mFirstColumnColorButton->setText(QString());
        mLastColumnCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Last column", nullptr));
        label_2->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Default cell background", nullptr));
        mDefaultColorButton->setText(QString());
        mFirstRowColorButton->setText(QString());
        mOddRowsColorButton->setText(QString());
        mOddRowsCheckBox->setText(QApplication::translate("QgsLayoutTableBackgroundDialog", "Odd rows", nullptr));
