...
public:
    ...
    {
        mProfileNewButton->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "New", nullptr));
        mProfileDeleteButton->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Remove", nullptr));
        mProfileResetButton->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Reset", nullptr));
        mProfileLabel->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Profile", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mOptionsTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mOptionsTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Value", nullptr));
        mOptionsAddButton->setText(QString());
        mOptionsDeleteButton->setText(QString());
        mOptionsValidateButton->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Validate", nullptr));
        mOptionsHelpButton->setText(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Help", nullptr));
#ifndef QT_NO_TOOLTIP
        mOptionsLineEdit->setToolTip(QApplication::translate("QgsRasterFormatSaveOptionsWidgetBase", "Insert KEY=VALUE pairs separated by spaces", nullptr));
#endif // QT_NO_TOOLTIP
