...
public:
    ...
    void setupUi(QWidget *PropertyGenericNumericAssistant)
    {
        ...
        maxOutputSpinBox->setMaximum(1e+08);
        ...
        nullOutputSpinBox->setMaximum(1e+08);
        ...
        minOutputSpinBox->setMaximum(1e+08);
    ...
    {
        mLabelMinOutput->setText(QApplication::translate("PropertyGenericNumericAssistant", "Output from", nullptr));
        mLabelNullOutput->setText(QApplication::translate("PropertyGenericNumericAssistant", "Output when NULL", nullptr));
        mExponentLabel->setText(QApplication::translate("PropertyGenericNumericAssistant", "Exponent", nullptr));
        label_6->setText(QApplication::translate("PropertyGenericNumericAssistant", "to", nullptr));
