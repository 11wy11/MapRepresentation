...
public:
    ...
    {
        QgsLayoutManualTableWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Attribute Table", nullptr));
        label->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Table", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Main Properties", nullptr));
        mSetContentsButton->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Edit Table\342\200\246", nullptr));
        groupBox_6->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Appearance", nullptr));
        mAdvancedCustomizationButton->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Advanced Customization\342\200\246", nullptr));
        mBackgroundColorButton->setText(QString());
        mMarginLabel->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Cell margins", nullptr));
        mMarginSpinBox->setSuffix(QApplication::translate("QgsLayoutManualTableWidgetBase", " mm", nullptr));
        label_10->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Background color", nullptr));
        label_12->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Oversized text", nullptr));
        mDrawEmptyCheckBox->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Show empty rows", nullptr));
        label_7->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Display header", nullptr));
        mShowGridGroupCheckBox->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Show Grid", nullptr));
        mGridStrokeWidthLabel->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Line width", nullptr));
        mGridStrokeWidthSpinBox->setSuffix(QApplication::translate("QgsLayoutManualTableWidgetBase", " mm", nullptr));
        label_6->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Color", nullptr));
        mGridColorButton->setText(QString());
        mDrawHorizontalGrid->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Draw horizontal lines", nullptr));
        mDrawVerticalGrid->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Draw vertical lines", nullptr));
        groupBox_4->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Fonts and Text Styling", nullptr));
        groupBox_3->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Table Heading", nullptr));
        label_5->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Font", nullptr));
        mHeaderFontToolButton->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Heading Font", nullptr));
        label_2->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Alignment", nullptr));
        groupBox_5->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Table Contents", nullptr));
        lblContentsFont->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Font", nullptr));
        mContentFontToolButton->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Contents Font", nullptr));
        frameGroupBox->setTitle(QApplication::translate("QgsLayoutManualTableWidgetBase", "Frames", nullptr));
        mResizeModeLabel->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Resize mode", nullptr));
        mAddFramePushButton->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Add Frame", nullptr));
        mEmptyFrameCheckBox->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Don't export page if frame is empty", nullptr));
        mHideEmptyBgCheckBox->setText(QApplication::translate("QgsLayoutManualTableWidgetBase", "Don't draw background if frame is empty", nullptr));
    } // retranslateUi
