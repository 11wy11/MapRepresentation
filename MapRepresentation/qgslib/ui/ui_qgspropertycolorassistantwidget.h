...
public:
    ...
    {
        label_8->setText(QApplication::translate("PropertyColorAssistant", "Color when NULL", nullptr));
        mNullColorButton->setText(QString());
        label->setText(QApplication::translate("PropertyColorAssistant", "Color ramp", nullptr));
