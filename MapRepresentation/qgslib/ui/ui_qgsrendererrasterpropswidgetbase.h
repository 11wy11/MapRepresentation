...
public:
    ...
    {
        label->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "This renderer doesn't implement a graphical interface.", nullptr));
        mLayerRendering->setTitle(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Layer Rendering", nullptr));
        mColorizeCheck->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Colorize", nullptr));
        btnColorizeColor->setText(QString());
        labelColorizeStrength->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Strength", nullptr));
        spinColorizeStrength->setSuffix(QApplication::translate("QgsRendererRasterPropsWidgetBase", "%", nullptr));
        label_3->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Hue", nullptr));
        mBlendTypeLabel->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Blending mode", nullptr));
        labelGrayscale->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Grayscale", nullptr));
        comboGrayscale->setItemText(0, QApplication::translate("QgsRendererRasterPropsWidgetBase", "Off", nullptr));
        comboGrayscale->setItemText(1, QApplication::translate("QgsRendererRasterPropsWidgetBase", "By lightness", nullptr));
        comboGrayscale->setItemText(2, QApplication::translate("QgsRendererRasterPropsWidgetBase", "By luminosity", nullptr));
        comboGrayscale->setItemText(3, QApplication::translate("QgsRendererRasterPropsWidgetBase", "By average", nullptr));

        label_2->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Brightness", nullptr));
#ifndef QT_NO_TOOLTIP
        mResetColorRenderingBtn->setToolTip(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Reset all color rendering options to default", nullptr));
#endif // QT_NO_TOOLTIP
        mResetColorRenderingBtn->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Reset", nullptr));
        label_5->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Contrast", nullptr));
        labelSaturation->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Saturation", nullptr));
        label_4->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Gamma", nullptr));
        mResamplingBox->setTitle(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Resampling", nullptr));
        mZoomedInResamplingLabel->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Zoomed in", nullptr));
        mZoomedOutResamplingLabel->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Zoomed out", nullptr));
        mMaximumOversamplingLabel->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Oversampling", nullptr));
        mCbEarlyResampling->setText(QApplication::translate("QgsRendererRasterPropsWidgetBase", "Early resampling", nullptr));
