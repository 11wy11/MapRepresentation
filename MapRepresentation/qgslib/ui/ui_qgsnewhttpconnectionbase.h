...
public:
    ...
    {
        QgsNewHttpConnectionBase->setWindowTitle(QApplication::translate("QgsNewHttpConnectionBase", "Create a New Connection", nullptr));
        mGroupBox->setTitle(QApplication::translate("QgsNewHttpConnectionBase", "Connection Details", nullptr));
        TextLabel1_2->setText(QApplication::translate("QgsNewHttpConnectionBase", "Name", nullptr));
#ifndef QT_NO_TOOLTIP
        txtName->setToolTip(QApplication::translate("QgsNewHttpConnectionBase", "Name of the new connection", nullptr));
#endif // QT_NO_TOOLTIP
        TextLabel1->setText(QApplication::translate("QgsNewHttpConnectionBase", "URL", nullptr));
#ifndef QT_NO_TOOLTIP
        txtUrl->setToolTip(QApplication::translate("QgsNewHttpConnectionBase", "HTTP address of the Web Map Server", nullptr));
#endif // QT_NO_TOOLTIP
        mWmsOptionsGroupBox->setTitle(QApplication::translate("QgsNewHttpConnectionBase", "WMS/WMTS Options", nullptr));
        cbxWmsIgnoreAxisOrientation->setText(QApplication::translate("QgsNewHttpConnectionBase", "Ignore axis orientation (WMS 1.3/WMTS)", nullptr));
        cbxIgnoreGetFeatureInfoURI->setText(QApplication::translate("QgsNewHttpConnectionBase", "Ignore GetFeatureInfo URI reported in capabilities", nullptr));
        cbxIgnoreGetMapURI->setText(QApplication::translate("QgsNewHttpConnectionBase", "Ignore GetMap/GetTile URI reported in capabilities", nullptr));
        cbxSmoothPixmapTransform->setText(QApplication::translate("QgsNewHttpConnectionBase", "Smooth pixmap transform", nullptr));
        cbxWmsInvertAxisOrientation->setText(QApplication::translate("QgsNewHttpConnectionBase", "Invert axis orientation", nullptr));
        lblDpiMode->setText(QApplication::translate("QgsNewHttpConnectionBase", "DPI-&Mode", nullptr));
        cbxWmsIgnoreReportedLayerExtents->setText(QApplication::translate("QgsNewHttpConnectionBase", "Ignore reported layer extents", nullptr));
        mWfsOptionsGroupBox->setTitle(QApplication::translate("QgsNewHttpConnectionBase", "WFS Options", nullptr));
        lblVersion->setText(QApplication::translate("QgsNewHttpConnectionBase", "Version", nullptr));
        mWfsVersionDetectButton->setText(QApplication::translate("QgsNewHttpConnectionBase", "Detect", nullptr));
        cbxWfsIgnoreAxisOrientation->setText(QApplication::translate("QgsNewHttpConnectionBase", "Ignore axis orientation (WFS 1.1/WFS 2.0)", nullptr));
        lblMaxNumFeatures->setText(QApplication::translate("QgsNewHttpConnectionBase", "Max. number of features", nullptr));
#ifndef QT_NO_TOOLTIP
        txtPageSize->setToolTip(QApplication::translate("QgsNewHttpConnectionBase", "<html><head/><body><p>Enter a number to limit the maximum number of features retrieved in a single GetFeature request when paging is enabled. If let to empty, server default will apply.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        cbxWfsInvertAxisOrientation->setText(QApplication::translate("QgsNewHttpConnectionBase", "Invert axis orientation", nullptr));
        lblPageSize->setText(QApplication::translate("QgsNewHttpConnectionBase", "Page size", nullptr));
        cbxWfsFeaturePaging->setText(QApplication::translate("QgsNewHttpConnectionBase", "Enable feature paging", nullptr));
#ifndef QT_NO_TOOLTIP
        txtMaxNumFeatures->setToolTip(QApplication::translate("QgsNewHttpConnectionBase", "<html><head/><body><p>Enter a number to limit the maximum number of features retrieved per feature request. If let to empty, no limit is set.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        cbxWfsUseGml2EncodingForTransactions->setToolTip(QApplication::translate("QgsNewHttpConnectionBase", "<html><head/><body><p>This might be necessary on some <span style=\" font-weight:600;\">broken</span> ESRI map servers when using WFS-T 1.1.0.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        cbxWfsUseGml2EncodingForTransactions->setText(QApplication::translate("QgsNewHttpConnectionBase", "Use GML2 encoding for transactions", nullptr));
        mAuthGroupBox->setTitle(QApplication::translate("QgsNewHttpConnectionBase", "Authentication", nullptr));
        mTestConnectionButton->setText(QApplication::translate("QgsNewHttpConnectionBase", "&Test Connection", nullptr));
        mHttpGroupBox->setTitle(QApplication::translate("QgsNewHttpConnectionBase", "HTTP", nullptr));
        label->setText(QApplication::translate("QgsNewHttpConnectionBase", "Referer", nullptr));
    } // retranslateUi
