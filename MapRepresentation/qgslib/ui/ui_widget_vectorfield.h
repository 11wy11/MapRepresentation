...
public:
    ...
    void setupUi(QWidget *WidgetVectorFieldBase)
    {
        ...
        mScaleSpinBox->setMaximum(1e+07);
    ...
    {
        mXAttributeLabel->setText(QApplication::translate("WidgetVectorFieldBase", "X attribute", nullptr));
        mYAttributeLabel->setText(QApplication::translate("WidgetVectorFieldBase", "Y attribute", nullptr));
        mDistanceUnitLabel->setText(QApplication::translate("WidgetVectorFieldBase", "Distance unit", nullptr));
        mScaleLabel->setText(QApplication::translate("WidgetVectorFieldBase", "Scale", nullptr));
        mFieldTypeGroupBox->setTitle(QApplication::translate("WidgetVectorFieldBase", "Vector Field Type", nullptr));
        mHeightRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Height only", nullptr));
        mPolarRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Polar", nullptr));
        mCartesianRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Cartesian", nullptr));
        mAngleUnitsGroupBox->setTitle(QApplication::translate("WidgetVectorFieldBase", "Angle Units", nullptr));
        mDegreesRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Degrees", nullptr));
        mRadiansRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Radians", nullptr));
        mAngleOrientationGroupBox->setTitle(QApplication::translate("WidgetVectorFieldBase", "Angle Orientation", nullptr));
        mClockwiseFromNorthRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Clockwise from north", nullptr));
        mCounterclockwiseFromEastRadioButton->setText(QApplication::translate("WidgetVectorFieldBase", "Counterclockwise from east", nullptr));
