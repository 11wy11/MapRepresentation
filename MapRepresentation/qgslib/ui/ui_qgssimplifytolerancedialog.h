...
public:
    ...
    {
        SimplifyUserInputWidgetBase->setWindowTitle(QApplication::translate("SimplifyUserInputWidgetBase", "Simplification Tool", nullptr));
        label_2->setText(QApplication::translate("SimplifyUserInputWidgetBase", "Method", nullptr));
        label->setText(QApplication::translate("SimplifyUserInputWidgetBase", "Tolerance", nullptr));
        label_3->setText(QApplication::translate("SimplifyUserInputWidgetBase", "Iterations", nullptr));
#ifndef QT_NO_TOOLTIP
        mIterationsSpin->setToolTip(QApplication::translate("SimplifyUserInputWidgetBase", "Number of smooth iterations. More iterations results in smoother geometries, at the expense of greatly increasing the number of vertices in those geometries.", nullptr));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("SimplifyUserInputWidgetBase", "Offset", nullptr));
#ifndef QT_NO_TOOLTIP
        mOffsetSpin->setToolTip(QApplication::translate("SimplifyUserInputWidgetBase", "Offset from existing vertices at which to insert smoothed vertices. Larger values result in \"looser\" smoothing, smaller values result in \"tight\" smoothing.", nullptr));
#endif // QT_NO_TOOLTIP
        mOffsetSpin->setSuffix(QApplication::translate("SimplifyUserInputWidgetBase", " %", nullptr));
    } // retranslateUi
