...
public:
    ...
    {
        QgsLayoutWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutWidgetBase", "Composition", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutWidgetBase", "General Settings", nullptr));
        label_2->setText(QApplication::translate("QgsLayoutWidgetBase", "Reference map", nullptr));
#ifndef QT_NO_TOOLTIP
        mReferenceMapComboBox->setToolTip(QApplication::translate("QgsLayoutWidgetBase", "Specifies the master map for this composition, which is used to georeference composer exports and for scale calculation for item styles.", nullptr));
#endif // QT_NO_TOOLTIP
        mSnapToGridGroupCheckBox->setTitle(QApplication::translate("QgsLayoutWidgetBase", "Guides and Grid", nullptr));
        mOffsetXSpinBox->setPrefix(QApplication::translate("QgsLayoutWidgetBase", "x: ", nullptr));
        mOffsetXSpinBox->setSuffix(QString());
        mOffsetYSpinBox->setPrefix(QApplication::translate("QgsLayoutWidgetBase", "y: ", nullptr));
        mOffsetYSpinBox->setSuffix(QString());
        mGridResolutionSpinBox->setPrefix(QString());
        mSnapToleranceSpinBox->setSuffix(QApplication::translate("QgsLayoutWidgetBase", " px", nullptr));
        label_8->setText(QApplication::translate("QgsLayoutWidgetBase", "Grid spacing", nullptr));
        label_6->setText(QApplication::translate("QgsLayoutWidgetBase", "Grid offset", nullptr));
        label_7->setText(QApplication::translate("QgsLayoutWidgetBase", "Snap tolerance", nullptr));
        groupBox_3->setTitle(QApplication::translate("QgsLayoutWidgetBase", "Export Settings", nullptr));
#ifndef QT_NO_TOOLTIP
        mGenerateWorldFileCheckBox->setToolTip(QApplication::translate("QgsLayoutWidgetBase", "If checked, a separate world file which georeferences exported images will be created", nullptr));
#endif // QT_NO_TOOLTIP
        mGenerateWorldFileCheckBox->setText(QApplication::translate("QgsLayoutWidgetBase", "Save world file", nullptr));
        label_9->setText(QApplication::translate("QgsLayoutWidgetBase", "Export resolution", nullptr));
        mResolutionSpinBox->setSuffix(QApplication::translate("QgsLayoutWidgetBase", " dpi", nullptr));
        mResolutionSpinBox->setPrefix(QString());
#ifndef QT_NO_TOOLTIP
        mRasterizeCheckBox->setToolTip(QApplication::translate("QgsLayoutWidgetBase", "If checked, exports from this layout will be rasterized.", nullptr));
#endif // QT_NO_TOOLTIP
        mRasterizeCheckBox->setText(QApplication::translate("QgsLayoutWidgetBase", "Print as raster", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        mForceVectorCheckBox->setText(QApplication::translate("QgsLayoutWidgetBase", "Always export as vectors", nullptr));
        groupBox_5->setTitle(QApplication::translate("QgsLayoutWidgetBase", "Resize Layout to Content", nullptr));
        label->setText(QApplication::translate("QgsLayoutWidgetBase", "Margin units", nullptr));
        label_4->setText(QApplication::translate("QgsLayoutWidgetBase", "Top margin", nullptr));
        label_5->setText(QApplication::translate("QgsLayoutWidgetBase", "Left", nullptr));
        label_11->setText(QApplication::translate("QgsLayoutWidgetBase", "Right", nullptr));
        label_12->setText(QApplication::translate("QgsLayoutWidgetBase", "Bottom", nullptr));
        mResizePageButton->setText(QApplication::translate("QgsLayoutWidgetBase", "Resize layout", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsLayoutWidgetBase", "Variables", nullptr));
    } // retranslateUi
