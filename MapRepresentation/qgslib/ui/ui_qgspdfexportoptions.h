...
public:
    ...
    {
        QgsPdfExportOptionsDialog->setWindowTitle(QApplication::translate("QgsPdfExportOptionsDialog", "PDF Export Options", nullptr));
        groupBox->setTitle(QApplication::translate("QgsPdfExportOptionsDialog", "Export Options", nullptr));
        label_6->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Text export", nullptr));
...
#endif // QT_NO_TOOLTIP
        mForceVectorCheckBox->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Always export as vectors", nullptr));
        mAppendGeoreferenceCheckbox->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Append georeference information", nullptr));
        mIncludeMetadataCheckbox->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Export RDF metadata (title, author, etc.)", nullptr));
        label_3->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Image compression", nullptr));
        mGeoPDFGroupBox->setTitle(QApplication::translate("QgsPdfExportOptionsDialog", "Create Geospatial PDF (GeoPDF)", nullptr));
        mGeoPdfUnavailableReason->setText(QString());
        mIncludeMapThemesCheck->setTitle(QApplication::translate("QgsPdfExportOptionsDialog", "Include multiple map themes", nullptr));
        label->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Format", nullptr));
        mExportGeoPdfFeaturesCheckBox->setTitle(QApplication::translate("QgsPdfExportOptionsDialog", "Layer Structure", nullptr));
        ...
        groupBox_2->setTitle(QApplication::translate("QgsPdfExportOptionsDialog", "Advanced Options", nullptr));
#ifndef QT_NO_TOOLTIP
        mDisableRasterTilingCheckBox->setToolTip(QApplication::translate("QgsPdfExportOptionsDialog", "Disables tiled rendering of raster layers. This setting may improve the export quality in some circumstances, at the cost of much greater memory usage during exports.", nullptr));
#endif // QT_NO_TOOLTIP
        mDisableRasterTilingCheckBox->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Disable tiled raster layer exports", nullptr));
        mSimplifyGeometriesCheckbox->setText(QApplication::translate("QgsPdfExportOptionsDialog", "Simplify geometries to reduce output file size", nullptr));
    } // retranslateUi
