...
public:
    ...
    {
        mCbxShowForm->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Show embedded form", nullptr));
        mCbxShowOpenFormButton->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Show open form button", nullptr));
        mCbxAllowNull->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Allow NULL value", nullptr));
        mCbxReadOnly->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Use a read-only line edit instead of a combobox", nullptr));
        label_2->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Relation", nullptr));
        mCbxOrderByValue->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Order by value", nullptr));
        mCbxMapIdentification->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "On map identification (for geometric layers only)", nullptr));
        label->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Display expression \342\222\276", nullptr));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("QgsRelReferenceConfigDlgBase", "This setting is not saved in the style. It is changing the display name on the referenced layer.", nullptr));
#endif // QT_NO_TOOLTIP
        mFilterGroupBox->setTitle(QApplication::translate("QgsRelReferenceConfigDlgBase", "Filters", nullptr));
        mAddFilterButton->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "\342\200\246", nullptr));
#ifndef QT_NO_TOOLTIP
        mCbxChainFilters->setToolTip(QApplication::translate("QgsRelReferenceConfigDlgBase", "When activated, the filters will restrict the choices of fields to options that are ", nullptr));
#endif // QT_NO_TOOLTIP
        mCbxChainFilters->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Chain filters", nullptr));
        label_3->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Filter expression", nullptr));
        mRemoveFilterButton->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "\342\200\246", nullptr));
        mCbxAllowAddFeatures->setText(QApplication::translate("QgsRelReferenceConfigDlgBase", "Allow adding new features", nullptr));
