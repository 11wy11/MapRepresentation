...
public:
    ...
    {
        mRendererLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Renderer", nullptr));
        mLabelingGroupBox->setTitle(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Labels", nullptr));
        mLabelDistanceLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Label distance factor", nullptr));
        mLabelColorLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Label color", nullptr));
        mLabelAttributeLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Label attribute", nullptr));
        mScaleDependentLabelsCheckBox->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Use scale dependent labeling", nullptr));
        mLabelColorButton->setText(QString());
        label->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Label font", nullptr));
        mMaxScaleLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Minimum map scale", nullptr));
        mLabelFontButton->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Font", nullptr));
        label_2->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Placement method", nullptr));
#ifndef QT_NO_TOOLTIP
        mDistanceToleranceLabel->setToolTip(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Point distance tolerance", nullptr));
#endif // QT_NO_TOOLTIP
        mDistanceToleranceLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Distance", nullptr));
        mRendererSettingsButton->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Renderer Settings\342\200\246", nullptr));
        mCenterSymbolLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Center symbol", nullptr));
        mDisplacementCirclesGroupBox->setTitle(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Displacement Lines", nullptr));
        mCircleColorButton->setText(QString());
        mCircleRadiusLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Size adjustment", nullptr));
        mCircleWidthLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Stroke width", nullptr));
        mCircleColorLabel->setText(QApplication::translate("QgsPointDisplacementRendererWidgetBase", "Stroke color", nullptr));
        mCircleModificationSpinBox->setSuffix(QApplication::translate("QgsPointDisplacementRendererWidgetBase", " mm", nullptr));
        mCircleWidthSpinBox->setSuffix(QApplication::translate("QgsPointDisplacementRendererWidgetBase", " mm", nullptr));
