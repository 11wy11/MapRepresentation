...
public:
    ...
    void setupUi(QWidget *QgsGraduatedSymbolRendererWidget)
    {
        ...
        minSizeSpinBox->setMaximum(1e+09);
        ...
        maxSizeSpinBox->setMaximum(1e+09);
    ...
    void retranslateUi(QWidget *QgsGraduatedSymbolRendererWidget)
    {
        ...
        methodComboBox->setToolTip(QApplication::translate("QgsGraduatedSymbolRendererWidget", "<html><head/><body><p>Choose between color and size graduation. </p><p><br/></p><p>If you want to combine both, use a data-defined size for the symbol and graduate by color.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Legend format", nullptr));
        labelMethod->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Method", nullptr));
        lblSize->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Size from", nullptr));
        label_4->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Value", nullptr));
        lblSizeTo->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "to", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        spinPrecision->setPrefix(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Precision ", nullptr));
#ifndef QT_NO_TOOLTIP
        cbxTrimTrailingZeroes->setToolTip(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Check to remove trailing zeroes after the decimal point from the upper and lower values in the legend.", nullptr));
#endif // QT_NO_TOOLTIP
        cbxTrimTrailingZeroes->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Trim", nullptr));
        btnChangeGraduatedSymbol->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Change\342\200\246", nullptr));
        lblColorRamp->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Color ramp", nullptr));
        label_6->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Symbol", nullptr));
        mGroupBoxSymmetric->setTitle(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Symmetric Classification", nullptr));
        label_2->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Around", nullptr));
        cbxAstride->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Create class astride symmetry value", nullptr));
        label_8->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Mode", nullptr));
        label_5->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Classes", nullptr));
        btnGraduatedClassify->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Classify", nullptr));
#ifndef QT_NO_TOOLTIP
        btnGraduatedAdd->setToolTip(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Add class", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        btnGraduatedDelete->setToolTip(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Delete", nullptr));
#endif // QT_NO_TOOLTIP
        btnDeleteAllClasses->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Delete All", nullptr));
        btnAdvanced->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Advanced", nullptr));
        cbxLinkBoundaries->setText(QApplication::translate("QgsGraduatedSymbolRendererWidget", "Link class boundaries", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("QgsGraduatedSymbolRendererWidget", "Classes", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("QgsGraduatedSymbolRendererWidget", "Histogram", nullptr));
