...
public:
    ...
    {
        QgsNewAuxiliaryLayerDialogBase->setWindowTitle(QApplication::translate("QgsNewAuxiliaryLayerDialogBase", "Auxiliary Storage : Choose Primary Key", nullptr));
        label->setText(QApplication::translate("QgsNewAuxiliaryLayerDialogBase", "Select the primary key to use for joining with internal data storage", nullptr));
    } // retranslateUi
