...
public:
    ...
    {
        QgsNewMemoryLayerDialogBase->setWindowTitle(QApplication::translate("QgsNewMemoryLayerDialogBase", "New Temporary Scratch Layer", nullptr));
        label->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Layer name", nullptr));
        label_3->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Geometry type", nullptr));
        mGeometryWithZCheckBox->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Include Z dimension", nullptr));
        mGeometryWithMCheckBox->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Include M values", nullptr));
        groupBox->setTitle(QApplication::translate("QgsNewMemoryLayerDialogBase", "New Field", nullptr));
        textLabel1->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Name", nullptr));
        textLabel2->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Type", nullptr));
        label_4->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Length", nullptr));
        label_5->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Precision", nullptr));
#ifndef QT_NO_TOOLTIP
        mAddAttributeButton->setToolTip(QApplication::translate("QgsNewMemoryLayerDialogBase", "Add field to list", nullptr));
#endif // QT_NO_TOOLTIP
        mAddAttributeButton->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Add to Fields List", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsNewMemoryLayerDialogBase", "Fields List", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = mAttributeView->headerItem();
        ___qtreewidgetitem->setText(3, QApplication::translate("QgsNewMemoryLayerDialogBase", "Precision", nullptr));
        ___qtreewidgetitem->setText(2, QApplication::translate("QgsNewMemoryLayerDialogBase", "Length", nullptr));
        ___qtreewidgetitem->setText(1, QApplication::translate("QgsNewMemoryLayerDialogBase", "Type", nullptr));
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsNewMemoryLayerDialogBase", "Name", nullptr));
#ifndef QT_NO_TOOLTIP
        mRemoveAttributeButton->setToolTip(QApplication::translate("QgsNewMemoryLayerDialogBase", "Delete selected field", nullptr));
#endif // QT_NO_TOOLTIP
        mRemoveAttributeButton->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "Remove Field", nullptr));
        label_2->setText(QApplication::translate("QgsNewMemoryLayerDialogBase", "<i><b>Warning:</b> Temporary scratch layers are not saved and will be discarded when QGIS is closed.</i>", nullptr));
    } // retranslateUi
