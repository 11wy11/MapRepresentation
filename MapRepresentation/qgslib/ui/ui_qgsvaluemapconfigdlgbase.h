...
public:
    ...
    {
        valueMapLabel->setText(QApplication::translate("QgsValueMapWidget", "Combo box with predefined items. Value is stored in the attribute, description is shown in the combo box.", nullptr));
        loadFromLayerButton->setText(QApplication::translate("QgsValueMapWidget", "Load Data from Layer", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsValueMapWidget", "Value", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsValueMapWidget", "Description", nullptr));
        addNullButton->setText(QApplication::translate("QgsValueMapWidget", "Add \"NULL\" value", nullptr));
        removeSelectedButton->setText(QApplication::translate("QgsValueMapWidget", "Remove Selected", nullptr));
        loadFromCSVButton->setText(QApplication::translate("QgsValueMapWidget", "Load Data from CSV File", nullptr));
