...
public:
    ...
    {
        QgsGeorefConfigDialogBase->setWindowTitle(QApplication::translate("QgsGeorefConfigDialogBase", "Configure Georeferencer", nullptr));
        mPointTipGroupBox->setTitle(QApplication::translate("QgsGeorefConfigDialogBase", "Point Tip", nullptr));
        mShowIDsCheckBox->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Show IDs", nullptr));
        mShowCoordsCheckBox->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Show coordinates", nullptr));
        mShowDockedCheckBox->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Show Georeferencer window docked", nullptr));
        groupBox->setTitle(QApplication::translate("QgsGeorefConfigDialogBase", "PDF Map", nullptr));
        label_3->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Paper size", nullptr));
        mPdfReportGroupBox->setTitle(QApplication::translate("QgsGeorefConfigDialogBase", "PDF Report", nullptr));
        label->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Left margin", nullptr));
        mLeftMarginSpinBox->setPrefix(QString());
        mLeftMarginSpinBox->setSuffix(QApplication::translate("QgsGeorefConfigDialogBase", " mm", nullptr));
        label_2->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Right margin", nullptr));
        mRightMarginSpinBox->setSuffix(QApplication::translate("QgsGeorefConfigDialogBase", " mm", nullptr));
        mResidualUnitsGroupBox->setTitle(QApplication::translate("QgsGeorefConfigDialogBase", "Residual Units", nullptr));
        mPixelsButton->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Pixels", nullptr));
        mMapUnitsButton->setText(QApplication::translate("QgsGeorefConfigDialogBase", "Use map units if possible", nullptr));
    } // retranslateUi
