...
public:
    ...
    {
        QgsDiscoverRelationsDialogBase->setWindowTitle(QApplication::translate("QgsDiscoverRelationsDialogBase", "Discover Relations", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mRelationsTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsDiscoverRelationsDialogBase", "Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mRelationsTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsDiscoverRelationsDialogBase", "Referencing Layer", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mRelationsTable->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("QgsDiscoverRelationsDialogBase", "Referencing Field", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = mRelationsTable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("QgsDiscoverRelationsDialogBase", "Referenced Layer", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = mRelationsTable->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("QgsDiscoverRelationsDialogBase", "Referenced Field", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = mRelationsTable->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("QgsDiscoverRelationsDialogBase", "Strength", nullptr));
    } // retranslateUi
