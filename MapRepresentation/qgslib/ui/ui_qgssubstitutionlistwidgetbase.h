...
public:
    ...
    void retranslateUi(QgsPanelWidget *QgsSubstitutionListWidgetBase)
    {
        ...
        ___qtablewidgetitem->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "Text", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mTableSubstitutions->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "Substitution", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mTableSubstitutions->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "Case Sensitive", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = mTableSubstitutions->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "Whole Word", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qtablewidgetitem3->setToolTip(QApplication::translate("QgsSubstitutionListWidgetBase", "If checked, only whole word matches are replaced", nullptr));
#endif // QT_NO_TOOLTIP
        mButtonAdd->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "\342\200\246", nullptr));
        mButtonRemove->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "\342\200\246", nullptr));
        mButtonImport->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "\342\200\246", nullptr));
        mButtonExport->setText(QApplication::translate("QgsSubstitutionListWidgetBase", "\342\200\246", nullptr));
