...
public:
    ...
    {
        QgsAttributeActionDialogBase->setWindowTitle(QApplication::translate("QgsAttributeActionDialogBase", "Attribute Actions", nullptr));
        groupBoxActionList->setTitle(QApplication::translate("QgsAttributeActionDialogBase", "Action List", nullptr));
#ifndef QT_NO_TOOLTIP
        mMoveDownButton->setToolTip(QApplication::translate("QgsAttributeActionDialogBase", "Move the selected action down", nullptr));
#endif // QT_NO_TOOLTIP
        mMoveDownButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        mRemoveButton->setToolTip(QApplication::translate("QgsAttributeActionDialogBase", "Remove the selected action", nullptr));
#endif // QT_NO_TOOLTIP
        mRemoveButton->setText(QString());
        mAddDefaultActionsButton->setText(QApplication::translate("QgsAttributeActionDialogBase", "Create Default Actions", nullptr));
#ifndef QT_NO_TOOLTIP
        mMoveUpButton->setToolTip(QApplication::translate("QgsAttributeActionDialogBase", "Move the selected action up", nullptr));
#endif // QT_NO_TOOLTIP
        mMoveUpButton->setText(QString());
        QTableWidgetItem *___qtablewidgetitem = mAttributeActionTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsAttributeActionDialogBase", "Type", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mAttributeActionTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsAttributeActionDialogBase", "Description", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mAttributeActionTable->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("QgsAttributeActionDialogBase", "Short Title", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = mAttributeActionTable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("QgsAttributeActionDialogBase", "Action", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = mAttributeActionTable->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("QgsAttributeActionDialogBase", "Capture", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = mAttributeActionTable->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("QgsAttributeActionDialogBase", "Action Scopes", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = mAttributeActionTable->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("QgsAttributeActionDialogBase", "On Notification", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qtablewidgetitem6->setToolTip(QApplication::translate("QgsAttributeActionDialogBase", "<html><head/><body><p>If not empty, this will enable provider notification listening and the action will be executed when the notification message matched the specified value. </p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        QTableWidgetItem *___qtablewidgetitem7 = mAttributeActionTable->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("QgsAttributeActionDialogBase", "Only when editable", nullptr));
...
#ifndef QT_NO_TOOLTIP
        mAddButton->setToolTip(QApplication::translate("QgsAttributeActionDialogBase", "Add a new action", nullptr));
#endif // QT_NO_TOOLTIP
        mAddButton->setText(QString());
        mShowInAttributeTable->setTitle(QApplication::translate("QgsAttributeActionDialogBase", "Show in Attribute Table", nullptr));
        label->setText(QApplication::translate("QgsAttributeActionDialogBase", "Layout", nullptr));
        mAttributeTableWidgetType->setItemText(0, QApplication::translate("QgsAttributeActionDialogBase", "Separate Buttons", nullptr));
        mAttributeTableWidgetType->setItemText(1, QApplication::translate("QgsAttributeActionDialogBase", "Combo Box", nullptr));
