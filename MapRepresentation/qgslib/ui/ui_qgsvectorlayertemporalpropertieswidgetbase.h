...
"background: white;QgsCollapsibleGroupBoxBasic::title, QgsCollapsibleGroupBox::title {  subcontrol-origin: margin;  subcontrol-position: top left;  margin-left: 20px;  margin-right: 5px;  left: 0px;  top: 1px;}QgsCollapsibleGroupBoxBasic::title, QgsCollapsi"
    ...
    {
        mTemporalGroupBox->setTitle(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Temporal", nullptr));
        label->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Configuration", nullptr));
        label_6->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Start date", nullptr));
        mStartTemporalDateTimeEdit->setDisplayFormat(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "M/d/yyyy h:mm AP", nullptr));
        mEndTemporalDateTimeEdit->setDisplayFormat(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "M/d/yyyy h:mm AP", nullptr));
        label_5->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "End date", nullptr));
        label_14->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "<p><b><i>All</i> features from the layer will be rendered whenever the map's temporal range overlaps the range defined below.</b></p>", nullptr));
        label_11->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Event duration", nullptr));
        label_2->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Field", nullptr));
        label_13->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "<p>Event durations in <i>Months</i> assume a fixed 30-day month length, and durations in <i>Years</i>, <i>Decades</i> or <i>Centuries</i> assume a 365.25-day year length.</p>", nullptr));
        label_28->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "<p><b>Individual features from the layer will be rendered if the field's value falls within the map's temporal range.</b></p>", nullptr));
#ifndef QT_NO_TOOLTIP
        mAccumulateCheckBox->setToolTip(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "If checked, then features will be shown whenever their defined temporal value falls within or before the map's temporal range", nullptr));
#endif // QT_NO_TOOLTIP
        mAccumulateCheckBox->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Accumulate features over time", nullptr));
        label_3->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Start field", nullptr));
        label_4->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "End field", nullptr));
...
"<p>If the <i>Start</i> field choice is empty, then features will be treated as having no start date. Similarly if the <i>End</i> field choice is empty, then features will be treated as having no end date.</p>", nullptr));
        label_8->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Start field", nullptr));
        label_12->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "<p>Event durations in <i>Months</i> assume a fixed 30-day month length, and durations in <i>Years</i>, <i>Decades</i> or <i>Centuries</i> assume a 365.25-day year length.</p>", nullptr));
        label_9->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Event duration field", nullptr));
        label_10->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Event duration units", nullptr));
        label_30->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "<p><b>Individual features from the layer will be rendered if the temporal range defined by the <i>Start</i> and <i>Event Duration</i> fields overlaps the map's temporal range.</b></p>", nullptr));
...
"<p>The <i>Start</i> and <i>End</i> expressions must return date or datetime values.</p>", nullptr));
        label_31->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "End expression", nullptr));
        label_32->setText(QApplication::translate("QgsVectorLayerTemporalPropertiesWidgetBase", "Start expression", nullptr));
