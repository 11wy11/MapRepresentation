...
public:
    ...
    {
        QgsExpressionStoreDialogBase->setWindowTitle(QApplication::translate("QgsExpressionStoreDialogBase", "Store Expression", nullptr));
        lblLabel->setText(QApplication::translate("QgsExpressionStoreDialogBase", "Label", nullptr));
        lblHelpText->setText(QApplication::translate("QgsExpressionStoreDialogBase", "Help text", nullptr));
        lblExpression->setText(QApplication::translate("QgsExpressionStoreDialogBase", "Expression", nullptr));
        mValidationError->setText(QApplication::translate("QgsExpressionStoreDialogBase", "A stored expression with this name already exists!", nullptr));
    } // retranslateUi
