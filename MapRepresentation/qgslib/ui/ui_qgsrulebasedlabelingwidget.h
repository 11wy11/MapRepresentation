...
public:
    ...
    void retranslateUi(QWidget *QgsRuleBasedLabelingWidget)
    {
        ...
        btnAddRule->setToolTip(QApplication::translate("QgsRuleBasedLabelingWidget", "Add rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnAddRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnEditRule->setToolTip(QApplication::translate("QgsRuleBasedLabelingWidget", "Edit rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnEditRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnRemoveRule->setToolTip(QApplication::translate("QgsRuleBasedLabelingWidget", "Remove rule", nullptr));
#endif // QT_NO_TOOLTIP
