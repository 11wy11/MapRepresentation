...
public:
    ...
    {
        mDrawInsideCheckBox->setText(QApplication::translate("WidgetCentroidFill", "Force placement of markers inside polygons", nullptr));
#ifndef QT_NO_TOOLTIP
        mDrawAllPartsCheckBox->setToolTip(QApplication::translate("WidgetCentroidFill", "When unchecked, a single marker will be drawn on the biggest part of multi-part features", nullptr));
#endif // QT_NO_TOOLTIP
        mDrawAllPartsCheckBox->setText(QApplication::translate("WidgetCentroidFill", "Draw markers on every part of multi-part features", nullptr));
        mClipPointsCheckBox->setText(QApplication::translate("WidgetCentroidFill", "Clip markers to polygon boundary", nullptr));
        mClipOnCurrentPartOnlyCheckBox->setText(QApplication::translate("WidgetCentroidFill", "Clip markers to current part boundary only", nullptr));
