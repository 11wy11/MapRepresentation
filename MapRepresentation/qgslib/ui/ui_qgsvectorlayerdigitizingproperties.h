...
public:
    ...
    {
        mGeometryAutoFixesGroupBox->setTitle(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "Automatic Fixes", nullptr));
        mRemoveDuplicateNodesCheckbox->setText(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "Remove duplicate nodes", nullptr));
...
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "Geometry precision", nullptr));
        mPrecisionUnitsLabel->setText(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "[Units]", nullptr));
        mGeometryPrecisionLineEdit->setText(QString());
        mGeometryPrecisionLineEdit->setPlaceholderText(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "[No precision restriction]", nullptr));
        mGeometryValidationGroupBox->setTitle(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "Geometry checks", nullptr));
        mTopologyChecksGroupBox->setTitle(QApplication::translate("QgsVectorLayerDigitizingPropertiesPage", "Topology checks", nullptr));
