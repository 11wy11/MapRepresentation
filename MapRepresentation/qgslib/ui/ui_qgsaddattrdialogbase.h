...
public:
    ...
    {
        QgsAddAttrDialogBase->setWindowTitle(QApplication::translate("QgsAddAttrDialogBase", "Add Field", nullptr));
        textLabel1->setText(QApplication::translate("QgsAddAttrDialogBase", "N&ame", nullptr));
        textLabel1_2->setText(QApplication::translate("QgsAddAttrDialogBase", "Comment", nullptr));
        textLabel2->setText(QApplication::translate("QgsAddAttrDialogBase", "Type", nullptr));
        label->setText(QApplication::translate("QgsAddAttrDialogBase", "Provider type", nullptr));
        mTypeName->setText(QApplication::translate("QgsAddAttrDialogBase", "Type", nullptr));
#ifndef QT_NO_TOOLTIP
        mLengthLabel->setToolTip(QApplication::translate("QgsAddAttrDialogBase", "Total length of field (including the number of digits after the decimal place for decimal fields).<br>For example 123.45 requires a decimal field length of 5, and 123456 requires an integer field length of 6.", nullptr));
#endif // QT_NO_TOOLTIP
        mLengthLabel->setText(QApplication::translate("QgsAddAttrDialogBase", "Length", nullptr));
#ifndef QT_NO_TOOLTIP
        mLength->setToolTip(QApplication::translate("QgsAddAttrDialogBase", "Total length of field (including the number of digits after the decimal place for decimal fields).<br>For example 123.45 requires a decimal field length of 5, and 123456 requires an integer field length of 6.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mPrecLabel->setToolTip(QApplication::translate("QgsAddAttrDialogBase", "Maximum number of digits after the decimal place. For example 123.45 requires a field precision of 2.", nullptr));
#endif // QT_NO_TOOLTIP
        mPrecLabel->setText(QApplication::translate("QgsAddAttrDialogBase", "Precision", nullptr));
#ifndef QT_NO_TOOLTIP
        mPrec->setToolTip(QApplication::translate("QgsAddAttrDialogBase", "Maximum number of digits after the decimal place. For example 123.45 requires a field precision of 2.", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
