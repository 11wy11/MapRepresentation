...
public:
    ...
    {
        QgsStatisticalSummaryWidgetBase->setWindowTitle(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Statistics", nullptr));
        mCancelButton->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Cancel", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mStatisticsTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Statistic", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mStatisticsTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Value", nullptr));
        mSelectedOnlyCheckBox->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Selected features only", nullptr));
#ifndef QT_NO_TOOLTIP
        mButtonCopy->setToolTip(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Copy Statistics to Clipboard", nullptr));
#endif // QT_NO_TOOLTIP
        mButtonCopy->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "\342\200\246", nullptr));
#ifndef QT_NO_TOOLTIP
        mButtonRefresh->setToolTip(QApplication::translate("QgsStatisticalSummaryWidgetBase", "Recalculate Statistics", nullptr));
#endif // QT_NO_TOOLTIP
        mButtonRefresh->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "\342\200\246", nullptr));
        mOptionsToolButton->setText(QApplication::translate("QgsStatisticalSummaryWidgetBase", "\342\200\246", nullptr));
    } // retranslateUi
