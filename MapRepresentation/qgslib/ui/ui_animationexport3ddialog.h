...
public:
    ...
    {
        AnimationExport3DDialog->setWindowTitle(QApplication::translate("AnimationExport3DDialog", "Export 3D Animation", nullptr));
        mHeightLabel->setText(QApplication::translate("AnimationExport3DDialog", "Output height", nullptr));
        mFpsLabel->setText(QApplication::translate("AnimationExport3DDialog", "Frames per second", nullptr));
#ifndef QT_NO_TOOLTIP
        mTemplateLineEdit->setToolTip(QApplication::translate("AnimationExport3DDialog", "Number of # represents number of digits (e.g. frame###.png -> frame001.png)", nullptr));
#endif // QT_NO_TOOLTIP
        mOutputDirLabel->setText(QApplication::translate("AnimationExport3DDialog", "Output directory", nullptr));
        mTemplateLabel->setText(QApplication::translate("AnimationExport3DDialog", "Template", nullptr));
        mWidthLabel->setText(QApplication::translate("AnimationExport3DDialog", "Output width", nullptr));
        mWidthSpinBox->setSuffix(QApplication::translate("AnimationExport3DDialog", " px", nullptr));
        mHeightSpinBox->setSuffix(QApplication::translate("AnimationExport3DDialog", " px", nullptr));
    } // retranslateUi
