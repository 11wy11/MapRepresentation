...
public:
    ...
    {
        QgsArcgisVectorTileConnectionDialog->setWindowTitle(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "ArcGIS Vector Tile Service Connection", nullptr));
        mGroupBox->setTitle(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Connection Details", nullptr));
        mAuthGroupBox->setTitle(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Authentication", nullptr));
        lblReferer->setText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Referer", nullptr));
        mCheckBoxZMin->setText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Min. Zoom Level", nullptr));
        label_2->setText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Service URL", nullptr));
        label->setText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Name", nullptr));
#ifndef QT_NO_TOOLTIP
        mEditReferer->setToolTip(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Optional custom referer", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mEditUrl->setToolTip(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "URL of the VectorTileServer API endpoint, e.g. https://domain/arcgis/rest/services/Layer_1/VectorTileServer", nullptr));
#endif // QT_NO_TOOLTIP
        mEditUrl->setPlaceholderText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "https://domain/arcgis/rest/services/Layer_1/VectorTileServer", nullptr));
#ifndef QT_NO_TOOLTIP
        mEditName->setToolTip(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Name of the new connection", nullptr));
#endif // QT_NO_TOOLTIP
        mCheckBoxZMax->setText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Max. Zoom Level", nullptr));
        label_3->setText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Style URL", nullptr));
#ifndef QT_NO_TOOLTIP
        mEditStyleUrl->setToolTip(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "If specified, will override the default style defined for the layer with the entered URL", nullptr));
#endif // QT_NO_TOOLTIP
        mEditStyleUrl->setPlaceholderText(QApplication::translate("QgsArcgisVectorTileConnectionDialog", "Optional", nullptr));
    } // retranslateUi
