...
public:
    ...
    {
        QgsLayoutLegendLayersDialogBase->setWindowTitle(QApplication::translate("QgsLayoutLegendLayersDialogBase", "Add Layer to Legend", nullptr));
        mFilterLineEdit->setPlaceholderText(QApplication::translate("QgsLayoutLegendLayersDialogBase", "Search", nullptr));
#ifndef QT_NO_TOOLTIP
        mCheckBoxVisibleLayers->setToolTip(QApplication::translate("QgsLayoutLegendLayersDialogBase", "If checked, only layers visible within the map will be listed", nullptr));
#endif // QT_NO_TOOLTIP
        mCheckBoxVisibleLayers->setText(QApplication::translate("QgsLayoutLegendLayersDialogBase", "Show visible layers only", nullptr));
    } // retranslateUi
