...
public:
    ...
    {
        QgsDecorationLayoutExtentDialog->setWindowTitle(QApplication::translate("QgsDecorationLayoutExtentDialog", "Layout Extents Properties", nullptr));
        grpEnable->setTitle(QApplication::translate("QgsDecorationLayoutExtentDialog", "Show Layout Extents", nullptr));
        mButtonFontStyle->setText(QApplication::translate("QgsDecorationLayoutExtentDialog", "Font", nullptr));
        mLineSymbolLabel->setText(QApplication::translate("QgsDecorationLayoutExtentDialog", "Symbol", nullptr));
        mCheckBoxLabelExtents->setText(QApplication::translate("QgsDecorationLayoutExtentDialog", "Label extents", nullptr));
