...
public:
    ...
    {
        QgsManageConnectionsDialogBase->setWindowTitle(QApplication::translate("QgsManageConnectionsDialogBase", "Manage Connections", nullptr));
        label->setText(QApplication::translate("QgsManageConnectionsDialogBase", "Select connections to export", nullptr));
    } // retranslateUi
