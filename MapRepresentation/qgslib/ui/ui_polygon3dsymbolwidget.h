...
public:
    ...
    void setupUi(QWidget *Polygon3DSymbolWidget)
    {
        ...
        cboCullingMode->addItem(QString());
        cboCullingMode->addItem(QString());
        cboCullingMode->addItem(QString());
    ...
    {
        label_2->setText(QApplication::translate("Polygon3DSymbolWidget", "Extrusion", nullptr));
        groupShading->setTitle(QApplication::translate("Polygon3DSymbolWidget", "Shading", nullptr));
        btnExtrusionDD->setText(QApplication::translate("Polygon3DSymbolWidget", "\342\200\246", nullptr));
        chkInvertNormals->setText(QApplication::translate("Polygon3DSymbolWidget", "Invert normals (experimental)", nullptr));
        cboAltClamping->setItemText(0, QApplication::translate("Polygon3DSymbolWidget", "Absolute", nullptr));
        cboAltClamping->setItemText(1, QApplication::translate("Polygon3DSymbolWidget", "Relative", nullptr));
        cboAltClamping->setItemText(2, QApplication::translate("Polygon3DSymbolWidget", "Terrain", nullptr));

        label_4->setText(QApplication::translate("Polygon3DSymbolWidget", "Altitude binding", nullptr));
        cboCullingMode->setItemText(0, QApplication::translate("Polygon3DSymbolWidget", "No Culling", nullptr));
        cboCullingMode->setItemText(1, QApplication::translate("Polygon3DSymbolWidget", "Front", nullptr));
        cboCullingMode->setItemText(2, QApplication::translate("Polygon3DSymbolWidget", "Back", nullptr));

        cboAltBinding->setItemText(0, QApplication::translate("Polygon3DSymbolWidget", "Vertex", nullptr));
        cboAltBinding->setItemText(1, QApplication::translate("Polygon3DSymbolWidget", "Centroid", nullptr));

        btnHeightDD->setText(QApplication::translate("Polygon3DSymbolWidget", "\342\200\246", nullptr));
        label_3->setText(QApplication::translate("Polygon3DSymbolWidget", "Altitude clamping", nullptr));
        groupEdges->setTitle(QApplication::translate("Polygon3DSymbolWidget", "Edges", nullptr));
        label_6->setText(QApplication::translate("Polygon3DSymbolWidget", "Width", nullptr));
        spinEdgeWidth->setSuffix(QApplication::translate("Polygon3DSymbolWidget", " px", nullptr));
        label_7->setText(QApplication::translate("Polygon3DSymbolWidget", "Color", nullptr));
        label_5->setText(QApplication::translate("Polygon3DSymbolWidget", "Culling mode", nullptr));
        chkAddBackFaces->setText(QApplication::translate("Polygon3DSymbolWidget", "Add back faces", nullptr));
        label->setText(QApplication::translate("Polygon3DSymbolWidget", "Height", nullptr));
        label_8->setText(QApplication::translate("Polygon3DSymbolWidget", "Rendered facade", nullptr));
        cboRenderedFacade->setItemText(0, QApplication::translate("Polygon3DSymbolWidget", "No Facades", nullptr));
        cboRenderedFacade->setItemText(1, QApplication::translate("Polygon3DSymbolWidget", "Walls", nullptr));
        cboRenderedFacade->setItemText(2, QApplication::translate("Polygon3DSymbolWidget", "Roofs", nullptr));
        cboRenderedFacade->setItemText(3, QApplication::translate("Polygon3DSymbolWidget", "Walls and Roofs", nullptr));
