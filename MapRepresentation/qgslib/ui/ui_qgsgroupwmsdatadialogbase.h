...
public:
    ...
    {
        QgsGroupWMSDataDialogBase->setWindowTitle(QApplication::translate("QgsGroupWMSDataDialogBase", "Set Group WMS Data", nullptr));
        mShortNameLabel->setText(QApplication::translate("QgsGroupWMSDataDialogBase", "Short name", nullptr));
#ifndef QT_NO_TOOLTIP
        mShortNameLineEdit->setToolTip(QApplication::translate("QgsGroupWMSDataDialogBase", "A name used to identify the group layer. The short name is a text string used for machine-to-machine communication.", nullptr));
#endif // QT_NO_TOOLTIP
        mShortNameLineEdit->setPlaceholderText(QApplication::translate("QgsGroupWMSDataDialogBase", "A name used to identify the group layer. The short name is a text string used for machine-to-machine communication.", nullptr));
        mTitleLineEdit->setPlaceholderText(QApplication::translate("QgsGroupWMSDataDialogBase", "The title is for the benefit of humans to identify group layer.", nullptr));
        mTitleLabel->setText(QApplication::translate("QgsGroupWMSDataDialogBase", "Title", nullptr));
        mAbstractLabel->setText(QApplication::translate("QgsGroupWMSDataDialogBase", "Abstract", nullptr));
#ifndef QT_NO_TOOLTIP
        mAbstractTextEdit->setToolTip(QApplication::translate("QgsGroupWMSDataDialogBase", "The abstract is a descriptive narrative providing more information about the group layer.", nullptr));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
