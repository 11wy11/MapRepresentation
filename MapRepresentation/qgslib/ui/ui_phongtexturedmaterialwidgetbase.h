...
public:
    ...
    {
        textureRotationSpinBox->setSuffix(QApplication::translate("PhongTexturedMaterialWidgetBase", " \302\260", nullptr));
        lblSpecular->setText(QApplication::translate("PhongTexturedMaterialWidgetBase", "Specular", nullptr));
        lblTextureScale->setText(QApplication::translate("PhongTexturedMaterialWidgetBase", "Texture scale", nullptr));
        textureScaleSpinBox->setSuffix(QApplication::translate("PhongTexturedMaterialWidgetBase", " %", nullptr));
        lblAmbient->setText(QApplication::translate("PhongTexturedMaterialWidgetBase", "Ambient", nullptr));
        lblTextureRotation->setText(QApplication::translate("PhongTexturedMaterialWidgetBase", "Texture rotation", nullptr));
        lblShininess->setText(QApplication::translate("PhongTexturedMaterialWidgetBase", "Shininess", nullptr));
        lblTextureScale_2->setText(QApplication::translate("PhongTexturedMaterialWidgetBase", "Diffuse texture", nullptr));
