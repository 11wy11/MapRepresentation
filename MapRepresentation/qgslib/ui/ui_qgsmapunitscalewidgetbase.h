...
public:
    ...
    {
        QgsMapUnitScaleWidgetBase->setWindowTitle(QApplication::translate("QgsMapUnitScaleWidgetBase", "Adjust Scaling Range", nullptr));
        groupBox->setTitle(QApplication::translate("QgsMapUnitScaleWidgetBase", "Scale Range", nullptr));
        label->setText(QApplication::translate("QgsMapUnitScaleWidgetBase", "Scale only within the following map unit scale range", nullptr));
        mCheckBoxMinScale->setText(QApplication::translate("QgsMapUnitScaleWidgetBase", "Minimum scale", nullptr));
        mCheckBoxMaxScale->setText(QApplication::translate("QgsMapUnitScaleWidgetBase", "Maximum scale", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsMapUnitScaleWidgetBase", "Size Range", nullptr));
        mCheckBoxMinSize->setText(QApplication::translate("QgsMapUnitScaleWidgetBase", "Minimum size", nullptr));
        mCheckBoxMaxSize->setText(QApplication::translate("QgsMapUnitScaleWidgetBase", "Maximum size", nullptr));
        mSpinBoxMinSize->setSuffix(QApplication::translate("QgsMapUnitScaleWidgetBase", " mm", nullptr));
        mSpinBoxMaxSize->setSuffix(QApplication::translate("QgsMapUnitScaleWidgetBase", " mm", nullptr));
        label_2->setText(QApplication::translate("QgsMapUnitScaleWidgetBase", "Scale only within the following size range", nullptr));
    } // retranslateUi
