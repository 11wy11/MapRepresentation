...
public:
    ...
    void retranslateUi(QWidget *QgsDateTimeEditConfig)
    {
        ...
        groupBox_2->setTitle(QApplication::translate("QgsDateTimeEditConfig", "Field Format", nullptr));
        mFieldHelpToolButton->setText(QApplication::translate("QgsDateTimeEditConfig", "\342\200\246", nullptr));
        groupBox->setTitle(QApplication::translate("QgsDateTimeEditConfig", "Widget Display", nullptr));
        mDisplayFormatComboBox->setItemText(0, QApplication::translate("QgsDateTimeEditConfig", "Default", nullptr));
        mDisplayFormatComboBox->setItemText(1, QApplication::translate("QgsDateTimeEditConfig", "Custom", nullptr));

        mDisplayHelpToolButton->setText(QApplication::translate("QgsDateTimeEditConfig", "\342\200\246", nullptr));
        mCalendarPopupCheckBox->setText(QApplication::translate("QgsDateTimeEditConfig", "Calendar popup", nullptr));
        mAllowNullCheckBox->setText(QApplication::translate("QgsDateTimeEditConfig", "Allow NULL values", nullptr));
        label->setText(QApplication::translate("QgsDateTimeEditConfig", "Preview", nullptr));
