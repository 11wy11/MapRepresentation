...
public:
    ...
    void retranslateUi(QWidget *QgsVectorTileBasicLabelingWidget)
    {
        ...
        btnAddRule->setToolTip(QApplication::translate("QgsVectorTileBasicLabelingWidget", "Add rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnAddRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnRemoveRule->setToolTip(QApplication::translate("QgsVectorTileBasicLabelingWidget", "Remove selected rules", nullptr));
#endif // QT_NO_TOOLTIP
        btnRemoveRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnEditRule->setToolTip(QApplication::translate("QgsVectorTileBasicLabelingWidget", "Edit current rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnEditRule->setText(QString());
        mLabelCurrentZoom->setText(QString());
#ifndef QT_NO_TOOLTIP
        mCheckVisibleOnly->setToolTip(QApplication::translate("QgsVectorTileBasicLabelingWidget", "Hides any rules which are invisible because they fall outside the current map canvas zoom level", nullptr));
#endif // QT_NO_TOOLTIP
        mCheckVisibleOnly->setText(QApplication::translate("QgsVectorTileBasicLabelingWidget", "Visible rules only", nullptr));
