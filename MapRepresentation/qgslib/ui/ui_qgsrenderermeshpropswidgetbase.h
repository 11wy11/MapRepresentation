...
public:
    ...
    {
        mActiveDatasetBlendingMode->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Layer Rendering", nullptr));
        label->setText(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Blending mode", nullptr));
        mStyleOptionsTab->setTabText(mStyleOptionsTab->indexOf(mActiveDatasetTab), QString());
        mContoursGroupBox->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Show Contours", nullptr));
        mStyleOptionsTab->setTabText(mStyleOptionsTab->indexOf(mContoursTab), QString());
        mVectorsGroupBox->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Show Vectors", nullptr));
        mStyleOptionsTab->setTabText(mStyleOptionsTab->indexOf(mVectorsTab), QString());
        mEdgeMeshGroupBox->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "1D Mesh", nullptr));
        mEdgeMeshGroup->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Edge Mesh Rendering", nullptr));
        mFaceMeshGroupBox->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "2D Mesh", nullptr));
        mNativeMeshGroup->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Native Mesh Rendering", nullptr));
        mTriangularMeshGroup->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Triangular Mesh Rendering", nullptr));
        mStyleOptionsTab->setTabText(mStyleOptionsTab->indexOf(mMeshTab), QString());
        groupBox->setTitle(QApplication::translate("QgsRendererMeshPropsWidgetBase", "Average 3D Stacked Mesh Results to 2D Dataset Values", nullptr));
