...
public:
    ...
    {
        label_4->setText(QApplication::translate("QgsCalendarConfigDlgBase", "A calendar widget to enter a date.", nullptr));
        label_10->setText(QApplication::translate("QgsCalendarConfigDlgBase", "Date format", nullptr));
