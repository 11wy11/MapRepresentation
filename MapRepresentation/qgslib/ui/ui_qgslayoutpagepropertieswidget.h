...
public:
    ...
    {
        QgsLayoutPagePropertiesWidget->setWindowTitle(QApplication::translate("QgsLayoutPagePropertiesWidget", "New Item Properties", nullptr));
        mSymbolButton->setText(QString());
        label->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "Background", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutPagePropertiesWidget", "Page Size", nullptr));
        mWidthLabel->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "Width", nullptr));
        mHeightSpin->setSuffix(QString());
        mWidthSpin->setSuffix(QString());
#ifndef QT_NO_TOOLTIP
        mLockAspectRatio->setToolTip(QApplication::translate("QgsLayoutPagePropertiesWidget", "Lock aspect ratio (including while drawing extent onto canvas)", nullptr));
#endif // QT_NO_TOOLTIP
        mWidthDDBtn->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "\342\200\246", nullptr));
        mHeightDDBtn->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "\342\200\246", nullptr));
        mHeightLabel->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "Height", nullptr));
        mPaperSizeDDBtn->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "\342\200\246", nullptr));
        label_3->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "Size", nullptr));
        mOrientationDDBtn->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "\342\200\246", nullptr));
        label_4->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "Orientation", nullptr));
#ifndef QT_NO_TOOLTIP
        mExcludePageCheckBox->setToolTip(QApplication::translate("QgsLayoutPagePropertiesWidget", "If checked, this page will not be included when exporting the layout", nullptr));
#endif // QT_NO_TOOLTIP
        mExcludePageCheckBox->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "Exclude page from exports", nullptr));
        mExcludePageDDBtn->setText(QApplication::translate("QgsLayoutPagePropertiesWidget", "\342\200\246", nullptr));
    } // retranslateUi
