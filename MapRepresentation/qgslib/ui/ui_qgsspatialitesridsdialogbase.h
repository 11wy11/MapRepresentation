...
public:
    ...
    {
        QgsSpatialiteSridsDialogBase->setWindowTitle(QApplication::translate("QgsSpatialiteSridsDialogBase", "Select a SpatiaLite Spatial Reference System", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = twSrids->headerItem();
        ___qtreewidgetitem->setText(2, QApplication::translate("QgsSpatialiteSridsDialogBase", "Reference Name", nullptr));
        ___qtreewidgetitem->setText(1, QApplication::translate("QgsSpatialiteSridsDialogBase", "Authority", nullptr));
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsSpatialiteSridsDialogBase", "SRID", nullptr));
        label->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "Search", nullptr));
        pbnFilter->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "Filter", nullptr));
        radioButtonSrid->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "SRID", nullptr));
        radioButtonName->setText(QApplication::translate("QgsSpatialiteSridsDialogBase", "Name", nullptr));
    } // retranslateUi
