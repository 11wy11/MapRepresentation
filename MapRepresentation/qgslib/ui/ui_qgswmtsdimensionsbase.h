...
public:
    ...
    {
        QgsWmtsDimensionsBase->setWindowTitle(QApplication::translate("QgsWmtsDimensionsBase", "Select Dimensions", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mDimensions->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsWmtsDimensionsBase", "Dimension", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mDimensions->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsWmtsDimensionsBase", "Value", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = mDimensions->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("QgsWmtsDimensionsBase", "Abstract", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = mDimensions->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("QgsWmtsDimensionsBase", "Default", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = mDimensions->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("QgsWmtsDimensionsBase", "Value", nullptr));
    } // retranslateUi
