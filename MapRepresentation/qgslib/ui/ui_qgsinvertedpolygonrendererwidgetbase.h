...
public:
    ...
    {
        mRendererLabel->setText(QApplication::translate("QgsInvertedPolygonRendererWidgetBase", "Sub renderer", nullptr));
#ifndef QT_NO_TOOLTIP
        mMergePolygonsCheckBox->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        mMergePolygonsCheckBox->setText(QApplication::translate("QgsInvertedPolygonRendererWidgetBase", "Merge polygons before rendering (slow)", nullptr));
