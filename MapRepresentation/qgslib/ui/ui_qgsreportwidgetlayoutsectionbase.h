...
public:
    ...
    {
        QgsReportWidgetLayoutSectionBase->setWindowTitle(QApplication::translate("QgsReportWidgetLayoutSectionBase", "Layout Manager", nullptr));
#ifndef QT_NO_TOOLTIP
        mButtonEditBody->setToolTip(QApplication::translate("QgsReportWidgetLayoutSectionBase", "Edit the static layout", nullptr));
#endif // QT_NO_TOOLTIP
        mButtonEditBody->setText(QApplication::translate("QgsReportWidgetLayoutSectionBase", "Edit", nullptr));
#ifndef QT_NO_TOOLTIP
        mCheckShowBody->setToolTip(QApplication::translate("QgsReportWidgetLayoutSectionBase", "Include a static layout inserted into the report", nullptr));
#endif // QT_NO_TOOLTIP
        mCheckShowBody->setText(QApplication::translate("QgsReportWidgetLayoutSectionBase", "Include section", nullptr));
    } // retranslateUi
