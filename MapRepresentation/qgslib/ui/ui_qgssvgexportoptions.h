...
public:
    ...
    {
        QgsSvgExportOptionsDialog->setWindowTitle(QApplication::translate("QgsSvgExportOptionsDialog", "SVG Export Options", nullptr));
        groupBox->setTitle(QApplication::translate("QgsSvgExportOptionsDialog", "Export Options", nullptr));
        chkMapLayersAsGroup->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Export map layers as SVG groups", nullptr));
        mIncludeMetadataCheckbox->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Export RDF metadata (title, author, etc.)", nullptr));
...
#endif // QT_NO_TOOLTIP
        mForceVectorCheckBox->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Always export as vectors", nullptr));
        label_6->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Text export", nullptr));
        mSimplifyGeometriesCheckbox->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Simplify geometries to reduce output file size", nullptr));
        mClipToContentGroupBox->setTitle(QApplication::translate("QgsSvgExportOptionsDialog", "Crop to Content", nullptr));
        label_5->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Left", nullptr));
        label_11->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Right", nullptr));
        label_12->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Bottom", nullptr));
        label_4->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Top margin (mm)", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsSvgExportOptionsDialog", "Advanced Options", nullptr));
#ifndef QT_NO_TOOLTIP
        mDisableRasterTilingCheckBox->setToolTip(QApplication::translate("QgsSvgExportOptionsDialog", "Disables tiled rendering of raster layers. This setting may improve the export quality in some circumstances, at the cost of much greater memory usage during exports.", nullptr));
#endif // QT_NO_TOOLTIP
        mDisableRasterTilingCheckBox->setText(QApplication::translate("QgsSvgExportOptionsDialog", "Disable tiled raster layer exports", nullptr));
    } // retranslateUi
