...
public:
    ...
    {
        QgsMeasureBase->setWindowTitle(QApplication::translate("QgsMeasureBase", "Measure", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = mTable->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsMeasureBase", "Segments", nullptr));
        totalDistanceLabel->setText(QApplication::translate("QgsMeasureBase", "Total", nullptr));
        totalHorizontalDistanceLabel->setText(QApplication::translate("QgsMeasureBase", "Total Horizontal Distance", nullptr));
        mEllipsoidal->setText(QApplication::translate("QgsMeasureBase", "Ellipsoidal", nullptr));
        mCartesian->setText(QApplication::translate("QgsMeasureBase", "Cartesian", nullptr));
        groupBox->setTitle(QApplication::translate("QgsMeasureBase", "Info", nullptr));
