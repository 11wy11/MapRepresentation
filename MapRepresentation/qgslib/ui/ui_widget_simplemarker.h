...
public:
    ...
    {
        label_3->setText(QApplication::translate("WidgetSimpleMarker", "Size", nullptr));
        mSizeDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mStrokeWidthLabel->setText(QApplication::translate("WidgetSimpleMarker", "Stroke width", nullptr));
        label->setText(QApplication::translate("WidgetSimpleMarker", "Stroke color", nullptr));
        mStrokeStyleLabel->setText(QApplication::translate("WidgetSimpleMarker", "Stroke style", nullptr));
        label_8->setText(QApplication::translate("WidgetSimpleMarker", "Join style", nullptr));
        spinAngle->setSuffix(QApplication::translate("WidgetSimpleMarker", " \302\260", nullptr));
        mAngleDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        label_2->setText(QApplication::translate("WidgetSimpleMarker", "Fill color", nullptr));
        mAnchorPointLabel->setText(QApplication::translate("WidgetSimpleMarker", "Anchor point", nullptr));
        label_4->setText(QApplication::translate("WidgetSimpleMarker", "Rotation", nullptr));
        label_5->setText(QApplication::translate("WidgetSimpleMarker", "Offset", nullptr));
        label_7->setText(QApplication::translate("WidgetSimpleMarker", "x", nullptr));
        label_6->setText(QApplication::translate("WidgetSimpleMarker", "y", nullptr));
        mJoinStyleDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mVerticalAnchorDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mNameDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mStrokeStyleDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mFillColorDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mHorizontalAnchorDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mStrokeColorDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mVerticalAnchorComboBox->setItemText(0, QApplication::translate("WidgetSimpleMarker", "Top", nullptr));
        mVerticalAnchorComboBox->setItemText(1, QApplication::translate("WidgetSimpleMarker", "VCenter", nullptr));
        mVerticalAnchorComboBox->setItemText(2, QApplication::translate("WidgetSimpleMarker", "Bottom", nullptr));

        mOffsetDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
        mHorizontalAnchorComboBox->setItemText(0, QApplication::translate("WidgetSimpleMarker", "Left", nullptr));
        mHorizontalAnchorComboBox->setItemText(1, QApplication::translate("WidgetSimpleMarker", "HCenter", nullptr));
        mHorizontalAnchorComboBox->setItemText(2, QApplication::translate("WidgetSimpleMarker", "Right", nullptr));

        btnChangeColorStroke->setText(QString());
        btnChangeColorFill->setText(QString());
        mStrokeWidthSpinBox->setSpecialValueText(QApplication::translate("WidgetSimpleMarker", "Hairline", nullptr));
        mStrokeWidthDDBtn->setText(QApplication::translate("WidgetSimpleMarker", "\342\200\246", nullptr));
