...
public:
    ...
    {
        label->setText(QApplication::translate("QgsMaskingWidgetBase", "Masked symbol layers", nullptr));
        label_2->setText(QApplication::translate("QgsMaskingWidgetBase", "Mask sources", nullptr));
