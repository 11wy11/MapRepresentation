...
public:
    ...
    {
        QgsLabelEngineConfigWidgetBase->setWindowTitle(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Automated Placement Engine", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Number of Candidates", nullptr));
        label_3->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Line (per cm)", nullptr));
        label_4->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Polygon (per cm\302\262)", nullptr));
        chkShowCandidates->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Show candidates (for debugging)", nullptr));
        label_6->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Color for unplaced labels", nullptr));
        mUnplacedColorButton->setText(QString());
        chkShowAllLabels->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Show all labels for all layers (i.e. including colliding objects)", nullptr));
        label_5->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Text rendering", nullptr));
        chkShowUnplaced->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Show unplaced labels", nullptr));
        chkShowPartialsLabels->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Allow truncated labels on edges of map", nullptr));
        label_7->setText(QApplication::translate("QgsLabelEngineConfigWidgetBase", "Project labeling version", nullptr));
    } // retranslateUi
