...
"2D/3D depends on this information being available", nullptr));
        ...
        mSpinMapRotateInterval->setProperty("specialValueText", QVariant(QApplication::translate("QgsGpsInformationWidgetBase", "On GPS signal", nullptr)));
        mSpinMapRotateInterval->setProperty("suffix", QVariant(QApplication::translate("QgsGpsInformationWidgetBase", " s", nullptr)));
