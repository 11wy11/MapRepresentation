...
public:
    ...
    {
        QgsCptCityColorRampDialogBase->setWindowTitle(QApplication::translate("QgsCptCityColorRampDialogBase", "Cpt-city Color Ramp", nullptr));
        lblCollectionInfo->setText(QString());
        label->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "License", nullptr));
        label_2->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "Palette", nullptr));
        label_6->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "Path", nullptr));
        lblPreview->setText(QString());
        lblSchemeName->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("QgsCptCityColorRampDialogBase", "Selection and Preview", nullptr));
        label_4->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "Author(s)", nullptr));
        lblAuthorName->setText(QString());
        label_3->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "Source", nullptr));
        lblSrcLink->setText(QString());
        label_5->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "License", nullptr));
        pbtnLicenseDetails->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "Details", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("QgsCptCityColorRampDialogBase", "Information", nullptr));
        cboConvertStandard->setText(QApplication::translate("QgsCptCityColorRampDialogBase", "Save as standard gradient", nullptr));
    } // retranslateUi
