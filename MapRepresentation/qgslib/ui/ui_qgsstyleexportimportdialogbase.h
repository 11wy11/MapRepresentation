...
public:
    ...
    {
        QgsStyleExportImportDialogBase->setWindowTitle(QApplication::translate("QgsStyleExportImportDialogBase", "Styles Import/Export", nullptr));
        mIgnoreXMLTags->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Do not import embedded tags", nullptr));
        tagHintLabel->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Tip: separate multiple tags with commas", nullptr));
        fromLabel->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Import from", nullptr));
        mLocationLabel->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Location", nullptr));
        mFavorite->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Add to favorites", nullptr));
        tagLabel->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Additional tag(s)", nullptr));
        mButtonFetch->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Fetch Items", nullptr));
        label->setText(QApplication::translate("QgsStyleExportImportDialogBase", "Select items to export", nullptr));
    } // retranslateUi
