...
public:
    ...
    {
        QgsStyleSaveDialog->setWindowTitle(QApplication::translate("QgsStyleSaveDialog", "Save New Style", nullptr));
        mLabelSaveAs->setText(QApplication::translate("QgsStyleSaveDialog", "Save as", nullptr));
        label_10->setText(QApplication::translate("QgsStyleSaveDialog", "Tip: separate multiple tags with commas", nullptr));
        mFavorite->setText(QApplication::translate("QgsStyleSaveDialog", "Add to favorites", nullptr));
        label_101->setText(QApplication::translate("QgsStyleSaveDialog", "Tag(s)", nullptr));
        label_1->setText(QApplication::translate("QgsStyleSaveDialog", "Name", nullptr));
    } // retranslateUi
