...
public:
    ...
    {
        label->setText(QApplication::translate("QgsUniqueValuesConfigDlgBase", "The user can select one of the values already used in the field. If editable, a line edit is shown with autocompletion support, otherwise a combo box is used.", nullptr));
        editableUniqueValues->setText(QApplication::translate("QgsUniqueValuesConfigDlgBase", "Editable", nullptr));
