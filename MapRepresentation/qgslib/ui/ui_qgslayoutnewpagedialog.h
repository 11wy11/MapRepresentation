...
public:
    ...
    {
        QgsLayoutNewPageDialog->setWindowTitle(QApplication::translate("QgsLayoutNewPageDialog", "Insert Pages", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutNewPageDialog", "Page Size", nullptr));
        label_3->setText(QApplication::translate("QgsLayoutNewPageDialog", "Size", nullptr));
        mWidthLabel->setText(QApplication::translate("QgsLayoutNewPageDialog", "Width", nullptr));
        label_4->setText(QApplication::translate("QgsLayoutNewPageDialog", "Orientation", nullptr));
        mHeightLabel->setText(QApplication::translate("QgsLayoutNewPageDialog", "Height", nullptr));
#ifndef QT_NO_TOOLTIP
        mLockAspectRatio->setToolTip(QApplication::translate("QgsLayoutNewPageDialog", "Lock aspect ratio (including while drawing extent onto canvas)", nullptr));
#endif // QT_NO_TOOLTIP
        mWidthSpin->setSuffix(QString());
        mHeightSpin->setSuffix(QString());
        label_2->setText(QApplication::translate("QgsLayoutNewPageDialog", "page(s)", nullptr));
        label->setText(QApplication::translate("QgsLayoutNewPageDialog", "Insert", nullptr));
        mPositionComboBox->setItemText(0, QApplication::translate("QgsLayoutNewPageDialog", "Before Page", nullptr));
        mPositionComboBox->setItemText(1, QApplication::translate("QgsLayoutNewPageDialog", "After Page", nullptr));
        mPositionComboBox->setItemText(2, QApplication::translate("QgsLayoutNewPageDialog", "At End", nullptr));
