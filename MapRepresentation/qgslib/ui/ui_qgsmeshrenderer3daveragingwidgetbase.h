...
public:
    ...
    {
        mAveragingMethodLabel_2->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Vertical layer index", nullptr));
        mSingleTopGroup->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: Value of top vertical layer", nullptr));
        mSingleTopPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "png", nullptr));
        mSingleTopDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Display the value from a vertical layer from the top (surface). The level is truncated to the maximum number of vertical layers for particular face.", nullptr));
        mAveragingMethodLabel_11->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Vertical layer index", nullptr));
        groupBox->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: Value of bottom vertical layer", nullptr));
        mSingleBottomPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        mSingleBottomDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Display the value from a vertical layer from the bottom (bed). The level is truncated to the maximum number of vertical layers for particular face.", nullptr));
        mAveragingMethodLabel_3->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Start vertical layer index", nullptr));
        mAveragingMethodLabel_5->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "End vertical layer index", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: first 2 vertical levels ", nullptr));
        mMultiTopPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        mMultiTopDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Averages values from multiple vertical layers from the top (surface). The level is truncated to the maximum number of vertical layers for particular face.", nullptr));
        mAveragingMethodLabel_4->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Start vertical layer index", nullptr));
        mAveragingMethodLabel_6->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "End vertical layer index", nullptr));
        groupBox_3->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: last 2 vertical levels", nullptr));
        mMultiBottomPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        mMultiBottomDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Averages values from multiple vertical layers from the bottom (bed). The level is truncated to the maximum number of vertical layers for particular face.", nullptr));
        mAveragingMethodLabel_7->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Start fraction ", nullptr));
        label->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "End fraction", nullptr));
        groupBox_4->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: Sigma range 0.25 - 0.75 ", nullptr));
        mSigmaPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        mSigmaDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Sigma averages over the values between 0 (bed level) and 1 (surface).", nullptr));
        mAveragingMethodLabel_8->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Start depth", nullptr));
        lab2->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "End depth", nullptr));
        groupBox_5->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: Depth 0.5 to 1.7", nullptr));
        mDepthPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        mDepthDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Depth averaging method averages the values based on range defined relative to surface. The range is defined in the same length units as defined by model (e.g. meters)", nullptr));
        mAveragingMethodLabel_9->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Start height", nullptr));
        labl->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "End height", nullptr));
        groupBox_6->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: Height 0-1.5m", nullptr));
        mHeightPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        mHeightDescLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Height averaging method averages the values based on range defined relative to bed elevation. The range is defined in the same length units as defined by model (e.g. meters)", nullptr));
        mAveragingMethodLabel_10->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Start elevation", nullptr));
        label_2->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "End elevation", nullptr));
        groupBox_7->setTitle(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Example: Elevation -0.5 to -2.5", nullptr));
        mElevationPngLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "..png...", nullptr));
        ...
        mAveragingMethodLabel->setText(QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Method", nullptr));
        mAveragingMethodComboBox->setItemText(0, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Single Vertical Level (from top)", nullptr));
        mAveragingMethodComboBox->setItemText(1, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Single Vertical Level (from bottom)", nullptr));
        mAveragingMethodComboBox->setItemText(2, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Multi Vertical Level (from top)", nullptr));
        mAveragingMethodComboBox->setItemText(3, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Multi Vertical Level (from bottom)", nullptr));
        mAveragingMethodComboBox->setItemText(4, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Sigma", nullptr));
        mAveragingMethodComboBox->setItemText(5, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Depth (relative to surface)", nullptr));
        mAveragingMethodComboBox->setItemText(6, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Height (relative to bed level)", nullptr));
        mAveragingMethodComboBox->setItemText(7, QApplication::translate("QgsMeshRenderer3dAveragingWidgetBase", "Elevation (absolute to model's datum)", nullptr));
