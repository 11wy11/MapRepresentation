...
public:
    ...
    {
        label_2->setText(QApplication::translate("QgsMeshRendererActiveDatasetWidgetBase", "Dataset in selected group(s)", nullptr));
        mActiveDatasetMetadataGroup->setTitle(QApplication::translate("QgsMeshRendererActiveDatasetWidgetBase", "Dataset group Metadata", nullptr));
