...
public:
    ...
    void setupUi(QWidget *ShadowRenderingSettingsWidget)
    {
        ...
        shadowBiasSpinBox->setSingleStep(1e-05);
        shadowBiasSpinBox->setValue(1e-05);
    ...
    {
        labelUsedDirectionalLight->setText(QApplication::translate("ShadowRenderingSettingsWidget", "Directional light", nullptr));
        labelShadowRenderinMaximumDistance->setText(QApplication::translate("ShadowRenderingSettingsWidget", "Shadow rendering maximum distance", nullptr));
        shadowRenderinMaximumDistanceSpinBox->setSuffix(QApplication::translate("ShadowRenderingSettingsWidget", " map units", nullptr));
        labelShadowBias->setText(QApplication::translate("ShadowRenderingSettingsWidget", "Shadow bias", nullptr));
        labelShadowMapResolution->setText(QApplication::translate("ShadowRenderingSettingsWidget", "Shadow map resolution", nullptr));
        shadowMapResolutionSpinBox->setSuffix(QApplication::translate("ShadowRenderingSettingsWidget", " px", nullptr));
