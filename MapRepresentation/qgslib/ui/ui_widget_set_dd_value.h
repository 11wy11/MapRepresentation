...
public:
    ...
    {
        mDDBtn->setText(QApplication::translate("QgsDataDefinedValueBaseDialog", "\342\200\246", nullptr));
        mLabel->setText(QApplication::translate("QgsDataDefinedValueBaseDialog", "Label", nullptr));
