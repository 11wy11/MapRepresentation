...
public:
    ...
    {
        QgsLayoutHtmlWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutHtmlWidgetBase", "HTML Frame", nullptr));
        label->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "HTML frame", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutHtmlWidgetBase", "HTML Source", nullptr));
#ifndef QT_NO_TOOLTIP
        mEvaluateExpressionsCheckbox->setToolTip(QApplication::translate("QgsLayoutHtmlWidgetBase", "If checked, expressions inside [% %] tags will be evaluated prior to rendering the HTML", nullptr));
#endif // QT_NO_TOOLTIP
        mEvaluateExpressionsCheckbox->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Evaluate QGIS expressions in HTML source", nullptr));
        mReloadPushButton->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Refresh HTML", nullptr));
        mFileToolButton->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "\342\200\246", nullptr));
        mUrlDDBtn->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "\342\200\246", nullptr));
        mRadioManualSource->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Source", nullptr));
        mRadioUrlSource->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "URL", nullptr));
        mInsertExpressionButton->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Insert or Edit an Expression\342\200\246", nullptr));
        frameGroupBox->setTitle(QApplication::translate("QgsLayoutHtmlWidgetBase", "Frames", nullptr));
        mEmptyFrameCheckBox->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Don't export page if frame is empty", nullptr));
        mAddFramePushButton->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Add Frame", nullptr));
        mResizeModeLabel->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Resize mode", nullptr));
        mHideEmptyBgCheckBox->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Don't draw background if frame is empty", nullptr));
        mUseSmartBreaksCheckBox->setTitle(QApplication::translate("QgsLayoutHtmlWidgetBase", "Use Smart Page Breaks", nullptr));
        mLabelMaxDistance->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Maximum distance", nullptr));
        mMaxDistanceSpinBox->setSuffix(QApplication::translate("QgsLayoutHtmlWidgetBase", " mm", nullptr));
        mUserStylesheetCheckBox->setTitle(QApplication::translate("QgsLayoutHtmlWidgetBase", "User Stylesheet", nullptr));
        mReloadPushButton2->setText(QApplication::translate("QgsLayoutHtmlWidgetBase", "Update HTML", nullptr));
    } // retranslateUi
