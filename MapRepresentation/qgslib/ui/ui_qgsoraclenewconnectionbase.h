...
public:
    ...
    {
        QgsOracleNewConnectionBase->setWindowTitle(QApplication::translate("QgsOracleNewConnectionBase", "Create a New Oracle Connection", nullptr));
        GroupBox1->setTitle(QApplication::translate("QgsOracleNewConnectionBase", "Connection Information", nullptr));
#ifndef QT_NO_TOOLTIP
        txtDatabase->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "Database name, or service name (described in tnsnames.ora) if no host and port has been set", nullptr));
#endif // QT_NO_TOOLTIP
        txtPort->setText(QApplication::translate("QgsOracleNewConnectionBase", "1521", nullptr));
#ifndef QT_NO_TOOLTIP
        txtName->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "Name of the new connection", nullptr));
#endif // QT_NO_TOOLTIP
        TextLabel3_4->setText(QApplication::translate("QgsOracleNewConnectionBase", "Workspace", nullptr));
        label->setText(QApplication::translate("QgsOracleNewConnectionBase", "Database", nullptr));
#ifndef QT_NO_TOOLTIP
        cb_onlyExistingTypes->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "Only list the existing geometry types and don't offer to add others.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        cb_onlyExistingTypes->setText(QApplication::translate("QgsOracleNewConnectionBase", "Only existing geometry types", nullptr));
#ifndef QT_NO_TOOLTIP
        cb_userTablesOnly->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "When searching for spatial tables restrict the search to tables that are owned by the user.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        cb_userTablesOnly->setWhatsThis(QApplication::translate("QgsOracleNewConnectionBase", "<html><head/><body><p>When searching for spatial tables restrict the search to tables that are owned by the user.</p></body></html>", nullptr));
#endif // QT_NO_WHATSTHIS
        cb_userTablesOnly->setText(QApplication::translate("QgsOracleNewConnectionBase", "Only look for user's tables", nullptr));
        TextLabel3_3->setText(QApplication::translate("QgsOracleNewConnectionBase", "Options", nullptr));
#ifndef QT_NO_TOOLTIP
        cb_useEstimatedMetadata->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "Use estimated table statistics for the layer metadata.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        cb_useEstimatedMetadata->setWhatsThis(QApplication::translate("QgsOracleNewConnectionBase", "<html><head/><body><p>When the layer is setup various metadata is required for the Oracle table. This includes information such as the table row count, geometry type and spatial extents of the data in the geometry column. If the table contains a large number of rows determining this metadata is time consuming.</p><p>By activating this option the following fast table metadata operations are done:</p><p>1) Row count is determined from all_tables.num_rows.</p><p>2) Table extents are always determined with the SDO_TUNE.EXTENTS_OF function even if a layer filter is applied.</p><p>3) The table geometry is determined from the first 100 non-null geometry rows in the table.</p></body></html>", nullptr));
#endif // QT_NO_WHATSTHIS
        cb_useEstimatedMetadata->setText(QApplication::translate("QgsOracleNewConnectionBase", "Use estimated table metadata", nullptr));
        TextLabel2_2->setText(QApplication::translate("QgsOracleNewConnectionBase", "Port", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_WHATSTHIS
        cb_includeGeoAttributes->setText(QApplication::translate("QgsOracleNewConnectionBase", "Include additional geometry attributes", nullptr));
        cb_allowGeometrylessTables->setText(QApplication::translate("QgsOracleNewConnectionBase", "Also list tables with no geometry", nullptr));
        TextLabel1_2->setText(QApplication::translate("QgsOracleNewConnectionBase", "Name", nullptr));
        TextLabel1->setText(QApplication::translate("QgsOracleNewConnectionBase", "Host", nullptr));
        TextLabel3_5->setText(QApplication::translate("QgsOracleNewConnectionBase", "Schema", nullptr));
#ifndef QT_NO_TOOLTIP
        txtSchema->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "If specified, only tables from the matching schema will be fetched and listed for the provider", nullptr));
#endif // QT_NO_TOOLTIP
        mAuthGroupBox->setTitle(QApplication::translate("QgsOracleNewConnectionBase", "Authentication", nullptr));
#ifndef QT_NO_TOOLTIP
        cb_geometryColumnsOnly->setToolTip(QApplication::translate("QgsOracleNewConnectionBase", "Restrict the displayed tables to those that are in the all_sdo_geom_metadata table", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        cb_geometryColumnsOnly->setWhatsThis(QApplication::translate("QgsOracleNewConnectionBase", "<html><head/><body><p>Restricts the displayed tables to those that are in the all_sdo_geom_metadata view. This can speed up the initial display of spatial tables.</p></body></html>", nullptr));
#endif // QT_NO_WHATSTHIS
        cb_geometryColumnsOnly->setText(QApplication::translate("QgsOracleNewConnectionBase", "Only look in metadata table", nullptr));
        btnConnect->setText(QApplication::translate("QgsOracleNewConnectionBase", "&Test Connect", nullptr));
    } // retranslateUi
