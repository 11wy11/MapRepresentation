...
public:
    ...
    {
        QgsNewVectorTableDialogBase->setWindowTitle(QApplication::translate("QgsNewVectorTableDialogBase", "Create Table", nullptr));
        mHasMChk->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Include values (M)", nullptr));
        mGeomColumnLabel->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Geometry column name", nullptr));
        mHasZChk->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Include Z dimension", nullptr));
        mValidationResults->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Validation results", nullptr));
        mWarningIcon->setText(QString());
        label_4->setText(QString());
        mDimensionsLabel->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Dimensions", nullptr));
        mGeomTypeCbo->setCurrentText(QString());
        label_3->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Geometry type", nullptr));
        mCrsLabel->setText(QApplication::translate("QgsNewVectorTableDialogBase", "CRS", nullptr));
        mSpatialIndexLabel->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Create spatial index", nullptr));
        mSpatialIndexChk->setText(QString());
        mAddFieldBtn->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Add Field", nullptr));
        mDeleteFieldBtn->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Remove Field", nullptr));
        mFieldUpBtn->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Up", nullptr));
        mFieldDownBtn->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Down", nullptr));
        mSchemaLabel->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Schema", nullptr));
        label->setText(QApplication::translate("QgsNewVectorTableDialogBase", "Name", nullptr));
    } // retranslateUi
