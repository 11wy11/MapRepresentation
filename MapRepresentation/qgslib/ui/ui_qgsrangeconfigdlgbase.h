...
public:
    ...
    {
        rangeLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Allows setting of numeric values from a specified range. The edit widget can be either a slider or a spin box.", nullptr));
        groupBox->setTitle(QApplication::translate("QgsRangeConfigDlgBase", "Advanced Options", nullptr));
        suffixLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Suffix", nullptr));
        suffixLineEdit->setPlaceholderText(QApplication::translate("QgsRangeConfigDlgBase", "Inactive", nullptr));
        precisionLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Precision", nullptr));
#ifndef QT_NO_TOOLTIP
        precisionSpinBox->setToolTip(QApplication::translate("QgsRangeConfigDlgBase", "Number of decimal places", nullptr));
#endif // QT_NO_TOOLTIP
        valuesLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Local minimum/maximum = 0/0", nullptr));
        minimumLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Minimum", nullptr));
        maximumLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Maximum", nullptr));
        stepLabel->setText(QApplication::translate("QgsRangeConfigDlgBase", "Step", nullptr));
        stepLabel_2->setText(QApplication::translate("QgsRangeConfigDlgBase", "Step", nullptr));
        maximumLabel_2->setText(QApplication::translate("QgsRangeConfigDlgBase", "Maximum", nullptr));
        minimumLabel_2->setText(QApplication::translate("QgsRangeConfigDlgBase", "Minimum", nullptr));
        allowNullCheckBox->setText(QApplication::translate("QgsRangeConfigDlgBase", "Allow NULL", nullptr));
