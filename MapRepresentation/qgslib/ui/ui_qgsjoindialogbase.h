...
public:
    ...
    {
        QgsJoinDialogBase->setWindowTitle(QApplication::translate("QgsJoinDialogBase", "Add Vector Join", nullptr));
        mJoinLayerLabel->setText(QApplication::translate("QgsJoinDialogBase", "Join layer", nullptr));
        mJoinFieldLabel->setText(QApplication::translate("QgsJoinDialogBase", "Join field", nullptr));
        mTargetFieldLabel->setText(QApplication::translate("QgsJoinDialogBase", "Target field", nullptr));
        mUseJoinFieldsSubset->setTitle(QApplication::translate("QgsJoinDialogBase", "&Joined fields", nullptr));
        mUseCustomPrefix->setTitle(QApplication::translate("QgsJoinDialogBase", "Custom field &name prefix", nullptr));
        mCacheInMemoryCheckBox->setText(QApplication::translate("QgsJoinDialogBase", "Cache join layer in memory", nullptr));
        mCreateIndexCheckBox->setText(QApplication::translate("QgsJoinDialogBase", "Create attribute index on join field", nullptr));
        mDynamicFormCheckBox->setText(QApplication::translate("QgsJoinDialogBase", "Dynamic form", nullptr));
        mEditableJoinLayer->setTitle(QApplication::translate("QgsJoinDialogBase", "Edi&table join layer", nullptr));
        mUpsertOnEditCheckBox->setText(QApplication::translate("QgsJoinDialogBase", "Upsert on edit", nullptr));
        mDeleteCascadeCheckBox->setText(QApplication::translate("QgsJoinDialogBase", "Delete cascade", nullptr));
    } // retranslateUi
