...
public:
    ...
    {
        label->setText(QApplication::translate("QgsGeoPackageProjectStorageDialog", "Connection", nullptr));
        label_3->setText(QApplication::translate("QgsGeoPackageProjectStorageDialog", "Project", nullptr));
