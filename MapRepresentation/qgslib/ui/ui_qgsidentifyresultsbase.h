...
public:
    ...
    void setupUi(QDialog *QgsIdentifyResultsBase)
    {
        ...
        mActionHideDerivedAttributes->setObjectName(QStringLiteral("mActionHideDerivedAttributes"));
    ...
    void retranslateUi(QDialog *QgsIdentifyResultsBase)
    {
        ...
        mActionHideDerivedAttributes->setText(QApplication::translate("QgsIdentifyResultsBase", "Hide Derived Attributes from Results", nullptr));
#ifndef QT_NO_TOOLTIP
        mActionHideDerivedAttributes->setToolTip(QApplication::translate("QgsIdentifyResultsBase", "Hide derived attributes from results", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
