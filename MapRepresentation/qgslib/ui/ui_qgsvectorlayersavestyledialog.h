...
public:
    ...
    {
        QgsVectorLayerSaveStyleDialog->setWindowTitle(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Save Layer Style", nullptr));
        mModeLabel->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Save style", nullptr));
        nameLabel->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Style name", nullptr));
        descriptionLabel->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Description", nullptr));
        mUILabel->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "UI", nullptr));
        mDbStyleUseAsDefault->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Use as default style for this layer", nullptr));
#ifndef QT_NO_TOOLTIP
        mDbStyleUIFileWidget->setToolTip(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Optionally pick an input form for attribute editing (QT Designer UI format), it will be stored in the database", nullptr));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Categories", nullptr));
        label->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "File", nullptr));
        mStylesWidgetLabel->setText(QApplication::translate("QgsVectorLayerSaveStyleDialog", "Styles", nullptr));
    } // retranslateUi
