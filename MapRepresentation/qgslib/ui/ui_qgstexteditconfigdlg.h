...
public:
    ...
    {
        mIsMultiline->setTitle(QApplication::translate("QgsTextEditConfigDlg", "Multiline", nullptr));
        mUseHtml->setText(QApplication::translate("QgsTextEditConfigDlg", "HTML", nullptr));
