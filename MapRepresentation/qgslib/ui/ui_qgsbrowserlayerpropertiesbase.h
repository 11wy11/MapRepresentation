...
public:
    ...
    {
        mTabWidget->setTabText(mTabWidget->indexOf(tab), QApplication::translate("QgsBrowserLayerPropertiesBase", "Metadata", nullptr));
        mTabWidget->setTabText(mTabWidget->indexOf(mPreviewTab), QApplication::translate("QgsBrowserLayerPropertiesBase", "Preview", nullptr));
        mTabWidget->setTabText(mTabWidget->indexOf(mAttributesTab), QApplication::translate("QgsBrowserLayerPropertiesBase", "Attributes", nullptr));
        mNoticeLabel->setText(QApplication::translate("QgsBrowserLayerPropertiesBase", "notice", nullptr));
