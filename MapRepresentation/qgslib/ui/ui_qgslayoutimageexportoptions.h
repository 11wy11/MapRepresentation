...
public:
    ...
    {
        QgsLayoutImageExportOptionsDialog->setWindowTitle(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Image Export Options", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Export Options", nullptr));
        label_13->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Page height", nullptr));
        mResolutionSpinBox->setSuffix(QApplication::translate("QgsLayoutImageExportOptionsDialog", " dpi", nullptr));
        mResolutionSpinBox->setPrefix(QString());
        label_9->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Export resolution", nullptr));
        mWidthSpinBox->setSpecialValueText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Auto", nullptr));
        mWidthSpinBox->setSuffix(QApplication::translate("QgsLayoutImageExportOptionsDialog", " px", nullptr));
        mWidthSpinBox->setPrefix(QString());
        label_10->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Page width", nullptr));
        mHeightSpinBox->setSpecialValueText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Auto", nullptr));
        mHeightSpinBox->setSuffix(QApplication::translate("QgsLayoutImageExportOptionsDialog", " px", nullptr));
        mHeightSpinBox->setPrefix(QString());
#ifndef QT_NO_TOOLTIP
        mGenerateWorldFile->setToolTip(QApplication::translate("QgsLayoutImageExportOptionsDialog", "If checked, a separate world file which georeferences exported images will be created", nullptr));
#endif // QT_NO_TOOLTIP
        mGenerateWorldFile->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Generate world file", nullptr));
#ifndef QT_NO_TOOLTIP
        mAntialiasingCheckBox->setToolTip(QApplication::translate("QgsLayoutImageExportOptionsDialog", "If unchecked, the generated images will not be antialiased", nullptr));
#endif // QT_NO_TOOLTIP
        mAntialiasingCheckBox->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Enable antialiasing", nullptr));
        mClipToContentGroupBox->setTitle(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Crop to Content", nullptr));
        label_5->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Left", nullptr));
        mLeftMarginSpinBox->setSuffix(QString());
        label_11->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Right", nullptr));
        mRightMarginSpinBox->setSuffix(QString());
        label_12->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Bottom", nullptr));
        label_4->setText(QApplication::translate("QgsLayoutImageExportOptionsDialog", "Top margin (px)", nullptr));
