...
public:
    ...
    {
        QgsLayoutMapLabelingWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "Map Options", nullptr));
        qgsCollapsibleGroupBoxBasic->setTitle(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "Placement", nullptr));
        label_10->setText(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "No labels will be placed within this distance of the map\342\200\231s edges, or from any label-blocking items which are checked below.", nullptr));
        mLabelBoundarySpinBox->setPrefix(QString());
        label_8->setText(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "<b>Margin from map edges</b>", nullptr));
        mLabelMarginDDBtn->setText(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "\342\200\246", nullptr));
        mShowPartialLabelsCheckBox->setText(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "Allow truncated labels on edges of map", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "Label Blocking Items", nullptr));
        label_9->setText(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "Avoid placing labels under these items", nullptr));
        mShowUnplacedCheckBox->setText(QApplication::translate("QgsLayoutMapLabelingWidgetBase", "Show unplaced labels", nullptr));
    } // retranslateUi
