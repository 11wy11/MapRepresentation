...
public:
    ...
    {
        QgsMasterPasswordResetDialog->setWindowTitle(QApplication::translate("QgsMasterPasswordResetDialog", "Reset Master Password", nullptr));
        label_6->setText(QApplication::translate("QgsMasterPasswordResetDialog", "Enter CURRENT master authentication password", nullptr));
        leMasterPassCurrent->setPlaceholderText(QApplication::translate("QgsMasterPasswordResetDialog", "Required", nullptr));
        label_7->setText(QApplication::translate("QgsMasterPasswordResetDialog", "Enter NEW master authentication password", nullptr));
        leMasterPassNew->setPlaceholderText(QApplication::translate("QgsMasterPasswordResetDialog", "Required", nullptr));
        chkKeepBackup->setText(QApplication::translate("QgsMasterPasswordResetDialog", "Keep backup of current database", nullptr));
