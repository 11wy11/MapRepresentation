...
public:
    ...
    {
        QgsLayoutMapClippingWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Map Options", nullptr));
        mClipToAtlasCheckBox->setTitle(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Clip to atlas feature", nullptr));
        label->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "The clipping mode determines how features from vector layers will be clipped.", nullptr));
        mClipToAtlasLabel->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "<b>When enabled, map layers will be automatically clipped to the boundary of the current atlas feature.</b>", nullptr));
        mRadioClipSelectedLayers->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Clip selected layers:", nullptr));
        mRadioClipAllLayers->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Clip all layers", nullptr));
        mForceLabelsInsideCheckBox->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Force labels inside atlas feature", nullptr));
        mClipToItemCheckBox->setTitle(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Clip to item", nullptr));
        label_2->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "The clipping mode determines how features from vector layers will be clipped.", nullptr));
        mClipToItemLabel->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "<b>When enabled, the map will be automatically clipped to the selected shape.</b>", nullptr));
        mForceLabelsInsideItemCheckBox->setText(QApplication::translate("QgsLayoutMapClippingWidgetBase", "Force labels inside clipping shape", nullptr));
    } // retranslateUi
