...
public:
    ...
    {
        QgsOgrSourceSelectBase->setWindowTitle(QApplication::translate("QgsOgrSourceSelectBase", "Add Vector Layer", nullptr));
        srcGroupBox_2->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Source Type", nullptr));
        radioSrcFile->setText(QApplication::translate("QgsOgrSourceSelectBase", "F&ile", nullptr));
        radioSrcDirectory->setText(QApplication::translate("QgsOgrSourceSelectBase", "&Directory", nullptr));
        radioSrcDatabase->setText(QApplication::translate("QgsOgrSourceSelectBase", "Da&tabase", nullptr));
        radioSrcProtocol->setText(QApplication::translate("QgsOgrSourceSelectBase", "Protoco&l: HTTP(S), cloud, etc.", nullptr));
        label_3->setText(QApplication::translate("QgsOgrSourceSelectBase", "Encoding", nullptr));
        protocolGroupBox->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Protocol", nullptr));
        label_2->setText(QApplication::translate("QgsOgrSourceSelectBase", "Type", nullptr));
        labelProtocolURI->setText(QApplication::translate("QgsOgrSourceSelectBase", "&URI", nullptr));
        labelBucket->setText(QApplication::translate("QgsOgrSourceSelectBase", "Bucket or container", nullptr));
        labelKey->setText(QApplication::translate("QgsOgrSourceSelectBase", "Object key", nullptr));
        mAuthWarning->setText(QApplication::translate("QgsOgrSourceSelectBase", "\342\200\246", nullptr));
        mAuthGroupBox->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Authentication", nullptr));
        fileGroupBox->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Source", nullptr));
        labelDirectoryType->setText(QApplication::translate("QgsOgrSourceSelectBase", "Type", nullptr));
        labelSrcDataset->setText(QApplication::translate("QgsOgrSourceSelectBase", "Vector Dataset(s)", nullptr));
        dbGroupBox->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Database", nullptr));
        label_4->setText(QApplication::translate("QgsOgrSourceSelectBase", "Type", nullptr));
        groupBox->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Connections", nullptr));
        btnNew->setText(QApplication::translate("QgsOgrSourceSelectBase", "New", nullptr));
        btnEdit->setText(QApplication::translate("QgsOgrSourceSelectBase", "Edit", nullptr));
        btnDelete->setText(QApplication::translate("QgsOgrSourceSelectBase", "Delete", nullptr));
        mOpenOptionsGroupBox->setTitle(QApplication::translate("QgsOgrSourceSelectBase", "Options", nullptr));
