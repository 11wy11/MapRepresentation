...
public:
    ...
    {
        QgsNewVectorLayerDialogBase->setWindowTitle(QApplication::translate("QgsNewVectorLayerDialogBase", "New Shapefile Layer", nullptr));
        groupBox->setTitle(QApplication::translate("QgsNewVectorLayerDialogBase", "New Field", nullptr));
        textLabel1->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Name", nullptr));
        textLabel2->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Type", nullptr));
        label->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Length", nullptr));
        label_2->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Precision", nullptr));
#ifndef QT_NO_TOOLTIP
        mAddAttributeButton->setToolTip(QApplication::translate("QgsNewVectorLayerDialogBase", "Add field to list", nullptr));
#endif // QT_NO_TOOLTIP
        mAddAttributeButton->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Add to Fields List", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsNewVectorLayerDialogBase", "Fields List", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = mAttributeView->headerItem();
        ___qtreewidgetitem->setText(3, QApplication::translate("QgsNewVectorLayerDialogBase", "Precision", nullptr));
        ___qtreewidgetitem->setText(2, QApplication::translate("QgsNewVectorLayerDialogBase", "Length", nullptr));
        ___qtreewidgetitem->setText(1, QApplication::translate("QgsNewVectorLayerDialogBase", "Type", nullptr));
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsNewVectorLayerDialogBase", "Name", nullptr));
#ifndef QT_NO_TOOLTIP
        mRemoveAttributeButton->setToolTip(QApplication::translate("QgsNewVectorLayerDialogBase", "Delete selected field", nullptr));
#endif // QT_NO_TOOLTIP
        mRemoveAttributeButton->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Remove Field", nullptr));
        mGeometryTypeLabel->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Geometry type", nullptr));
        mFileFormatLabel_2->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "File encoding", nullptr));
        mFileFormatLabel->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "File format", nullptr));
        mFileNameLabel->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "File name", nullptr));
        mAdditionalDimensionsLabel->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Additional dimensions", nullptr));
        mGeometryWithNoneRadioButton->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "None", nullptr));
        mGeometryWithZRadioButton->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "Z (+ M values)", nullptr));
        mGeometryWithMRadioButton->setText(QApplication::translate("QgsNewVectorLayerDialogBase", "M values", nullptr));
    } // retranslateUi
