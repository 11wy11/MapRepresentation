...
public:
    ...
    {
        label_19->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Filter expression", nullptr));
        label_nofColumns->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Number of columns", nullptr));
        label_8->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Select layer, key column and value column", nullptr));
        label_5->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Layer", nullptr));
        mAllowMulti->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Allow multiple selections", nullptr));
        mAllowNull->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Allow NULL value", nullptr));
        mUseCompleter->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Use completer", nullptr));
        mOrderByValue->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Order by value", nullptr));
        label_6->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Key column", nullptr));
        label_7->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Value column", nullptr));
        label->setText(QApplication::translate("QgsValueRelationConfigDlgBase", "Description column", nullptr));
