...
public:
    ...
    void retranslateUi(QWidget *QgsVectorTileBasicRendererWidget)
    {
        ...
        btnAddRule->setToolTip(QApplication::translate("QgsVectorTileBasicRendererWidget", "Add rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnAddRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnRemoveRule->setToolTip(QApplication::translate("QgsVectorTileBasicRendererWidget", "Remove selected rules", nullptr));
#endif // QT_NO_TOOLTIP
        btnRemoveRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnEditRule->setToolTip(QApplication::translate("QgsVectorTileBasicRendererWidget", "Edit current rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnEditRule->setText(QString());
        mLabelCurrentZoom->setText(QString());
#ifndef QT_NO_TOOLTIP
        mCheckVisibleOnly->setToolTip(QApplication::translate("QgsVectorTileBasicRendererWidget", "Hides any rules which are invisible because they fall outside the current map canvas zoom level", nullptr));
#endif // QT_NO_TOOLTIP
        mCheckVisibleOnly->setText(QApplication::translate("QgsVectorTileBasicRendererWidget", "Visible rules only", nullptr));
