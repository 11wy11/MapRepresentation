...
public:
    ...
    void retranslateUi(QWidget *QgsRuleBased3DRendererWidget)
    {
        ...
        btnAddRule->setToolTip(QApplication::translate("QgsRuleBased3DRendererWidget", "Add rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnAddRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnEditRule->setToolTip(QApplication::translate("QgsRuleBased3DRendererWidget", "Edit rule", nullptr));
#endif // QT_NO_TOOLTIP
        btnEditRule->setText(QString());
#ifndef QT_NO_TOOLTIP
        btnRemoveRule->setToolTip(QApplication::translate("QgsRuleBased3DRendererWidget", "Remove rule", nullptr));
#endif // QT_NO_TOOLTIP
