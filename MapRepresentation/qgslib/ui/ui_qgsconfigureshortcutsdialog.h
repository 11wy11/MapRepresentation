...
public:
    ...
    {
        QgsConfigureShortcutsDialog->setWindowTitle(QApplication::translate("QgsConfigureShortcutsDialog", "Keyboard Shortcuts", nullptr));
        mLeFilter->setPlaceholderText(QApplication::translate("QgsConfigureShortcutsDialog", "Search\342\200\246", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = treeActions->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("QgsConfigureShortcutsDialog", "Shortcut", nullptr));
        ___qtreewidgetitem->setText(0, QApplication::translate("QgsConfigureShortcutsDialog", "Action", nullptr));
        btnChangeShortcut->setText(QApplication::translate("QgsConfigureShortcutsDialog", "Change", nullptr));
        btnSetNoShortcut->setText(QApplication::translate("QgsConfigureShortcutsDialog", "Set None", nullptr));
        btnResetShortcut->setText(QApplication::translate("QgsConfigureShortcutsDialog", "Set Default", nullptr));
        btnLoadShortcuts->setText(QApplication::translate("QgsConfigureShortcutsDialog", "Load\342\200\246", nullptr));
        btnSaveShortcuts->setText(QApplication::translate("QgsConfigureShortcutsDialog", "Save\342\200\246", nullptr));
    } // retranslateUi
