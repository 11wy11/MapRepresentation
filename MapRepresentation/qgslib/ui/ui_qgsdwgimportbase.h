...
public:
    ...
    {
        QgsDwgImportBase->setWindowTitle(QApplication::translate("QgsDwgImportBase", "DWG/DXF Import", nullptr));
        mGroupBox->setTitle(QApplication::translate("QgsDwgImportBase", "Layers to Import into Project", nullptr));
        QTableWidgetItem *___qtablewidgetitem = mLayers->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("QgsDwgImportBase", "Layer", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = mLayers->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("QgsDwgImportBase", "Visible", nullptr));
        label_3->setText(QApplication::translate("QgsDwgImportBase", "Group name", nullptr));
        cbMergeLayers->setText(QApplication::translate("QgsDwgImportBase", "Merge layers", nullptr));
        pbDeselectAll->setText(QApplication::translate("QgsDwgImportBase", "Deselect All", nullptr));
        pbSelectAll->setText(QApplication::translate("QgsDwgImportBase", "Select All", nullptr));
        groupBox->setTitle(QApplication::translate("QgsDwgImportBase", "Import Drawing into GeoPackage", nullptr));
        pbImportDrawing->setText(QApplication::translate("QgsDwgImportBase", "Reload", nullptr));
        pbBrowseDrawing->setText(QApplication::translate("QgsDwgImportBase", "Import", nullptr));
        label_2->setText(QApplication::translate("QgsDwgImportBase", "Source drawing", nullptr));
        label->setText(QApplication::translate("QgsDwgImportBase", "Target package", nullptr));
        label_4->setText(QApplication::translate("QgsDwgImportBase", "CRS", nullptr));
        mDatabaseFileWidget->setDialogTitle(QApplication::translate("QgsDwgImportBase", "Select GeoPackage Database", nullptr));
        pbLoadDatabase->setText(QApplication::translate("QgsDwgImportBase", "Load layers", nullptr));
        cbExpandInserts->setText(QApplication::translate("QgsDwgImportBase", "Expand block references", nullptr));
        cbUseCurves->setText(QApplication::translate("QgsDwgImportBase", "Use curves", nullptr));
    } // retranslateUi
