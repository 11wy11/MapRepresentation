...
public:
    ...
    void setupUi(QWidget *QgsLayout3DMapWidgetBase)
    {
        ...
        mCenterYSpinBox->setMinimum(-1e+07);
        mCenterYSpinBox->setMaximum(1e+07);
        ...
        mDistanceToCenterSpinBox->setMaximum(1e+07);
        ...
        mCenterXSpinBox->setMinimum(-1e+07);
        mCenterXSpinBox->setMaximum(1e+07);
        ...
        mCenterZSpinBox->setMinimum(-1e+07);
        mCenterZSpinBox->setMaximum(1e+07);
    ...
    {
        QgsLayout3DMapWidgetBase->setWindowTitle(QApplication::translate("QgsLayout3DMapWidgetBase", "3D Map", nullptr));
        mLabel->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "3D Map", nullptr));
        groupBox_3->setTitle(QApplication::translate("QgsLayout3DMapWidgetBase", "Scene Settings", nullptr));
        mCopySettingsButton->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Copy Settings from a 3D View\342\200\246", nullptr));
        groupBox_4->setTitle(QApplication::translate("QgsLayout3DMapWidgetBase", "Camera Pose", nullptr));
        label->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Center X", nullptr));
        label_4->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Center Z", nullptr));
        label_3->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Center Y", nullptr));
        mHeadingAngleSpinBox->setSuffix(QApplication::translate("QgsLayout3DMapWidgetBase", " \302\260", nullptr));
        label_7->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Heading", nullptr));
        label_6->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Pitch", nullptr));
        mPitchAngleSpinBox->setSuffix(QApplication::translate("QgsLayout3DMapWidgetBase", " \302\260", nullptr));
        label_5->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Distance", nullptr));
        mPoseFromViewButton->setText(QApplication::translate("QgsLayout3DMapWidgetBase", "Set from a 3D View\342\200\246", nullptr));
    } // retranslateUi
