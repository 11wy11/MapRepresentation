...
public:
    ...
    {
        QgsTableEditorBase->setWindowTitle(QApplication::translate("QgsTableEditorBase", "Main Window", nullptr));
        mActionSetForeground->setText(QApplication::translate("QgsTableEditorBase", "Set Foreground Color\342\200\246", nullptr));
        mActionSetBackground->setText(QApplication::translate("QgsTableEditorBase", "Set Background Color\342\200\246", nullptr));
        mActionInsertRowsAbove->setText(QApplication::translate("QgsTableEditorBase", "Rows Above", nullptr));
        mActionInsertRowsBelow->setText(QApplication::translate("QgsTableEditorBase", "Rows Below", nullptr));
        mActionInsertColumnsBefore->setText(QApplication::translate("QgsTableEditorBase", "Columns Before", nullptr));
        mActionInsertColumnsAfter->setText(QApplication::translate("QgsTableEditorBase", "Columns After", nullptr));
        mActionDeleteRows->setText(QApplication::translate("QgsTableEditorBase", "Delete Rows", nullptr));
        mActionDeleteColumns->setText(QApplication::translate("QgsTableEditorBase", "Delete Columns", nullptr));
        mActionSelectAll->setText(QApplication::translate("QgsTableEditorBase", "Select All", nullptr));
        mActionSelectRow->setText(QApplication::translate("QgsTableEditorBase", "Select Row", nullptr));
        mActionSelectColumn->setText(QApplication::translate("QgsTableEditorBase", "Select Column", nullptr));
        mActionImportFromClipboard->setText(QApplication::translate("QgsTableEditorBase", "Import Content from Clipboard", nullptr));
        mActionClose->setText(QApplication::translate("QgsTableEditorBase", "Close Editor", nullptr));
        mActionSetRowHeight->setText(QApplication::translate("QgsTableEditorBase", "Set Row Height\342\200\246", nullptr));
        mActionSetColumnWidth->setText(QApplication::translate("QgsTableEditorBase", "Set Column Width\342\200\246", nullptr));
        mActionClear->setText(QApplication::translate("QgsTableEditorBase", "Clear Cell(s)", nullptr));
        mActionIncludeHeader->setText(QApplication::translate("QgsTableEditorBase", "Include Header Row", nullptr));
        menu_Table->setTitle(QApplication::translate("QgsTableEditorBase", "&Table", nullptr));
        menuInsert_Rows->setTitle(QApplication::translate("QgsTableEditorBase", "Insert Rows", nullptr));
        menuInsert_Columns->setTitle(QApplication::translate("QgsTableEditorBase", "Insert Columns", nullptr));
        menu_Edit->setTitle(QApplication::translate("QgsTableEditorBase", "&Edit", nullptr));
        menuFile->setTitle(QApplication::translate("QgsTableEditorBase", "File", nullptr));
    } // retranslateUi
