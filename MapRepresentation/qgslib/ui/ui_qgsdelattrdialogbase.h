...
public:
    ...
    {
        QgsDelAttrDialogBase->setWindowTitle(QApplication::translate("QgsDelAttrDialogBase", "Delete Fields", nullptr));
        mEditModeInfo->setText(QApplication::translate("QgsDelAttrDialogBase", "Provider fields can only be deleted when the layer is in edit mode.", nullptr));
        mCanDeleteAttributesInfo->setText(QApplication::translate("QgsDelAttrDialogBase", "Provider does not support deleting fields.", nullptr));
    } // retranslateUi
