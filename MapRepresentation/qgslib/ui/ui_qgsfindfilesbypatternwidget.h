...
public:
    ...
    {
        mFindButton->setText(QApplication::translate("QgsFindFilesByPatternWidgetBase", "Find Files", nullptr));
        label_2->setText(QApplication::translate("QgsFindFilesByPatternWidgetBase", "File pattern", nullptr));
        mPatternLineEdit->setPlaceholderText(QApplication::translate("QgsFindFilesByPatternWidgetBase", "Pattern to match, e.g. *.shp", nullptr));
        label->setText(QApplication::translate("QgsFindFilesByPatternWidgetBase", "Look in", nullptr));
        mRecursiveCheckBox->setText(QApplication::translate("QgsFindFilesByPatternWidgetBase", "Search recursively", nullptr));
