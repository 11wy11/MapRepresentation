...
public:
    ...
    {
        QgsLayoutAttributeTableWidgetBase->setWindowTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Attribute Table", nullptr));
        label->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Attribute table", nullptr));
        groupBox->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Main Properties", nullptr));
        label_8->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Source", nullptr));
        mRelationLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Relation", nullptr));
        mRefreshPushButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Refresh Table Data", nullptr));
        mAttributesPushButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Attributes\342\200\246", nullptr));
        mLayerLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Layer", nullptr));
        mLayerSourceDDBtn->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "\342\200\246", nullptr));
        groupBox_5->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Feature Filtering", nullptr));
        mMaxNumFeaturesLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Maximum rows", nullptr));
        mUniqueOnlyCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Remove duplicate rows from table", nullptr));
        mShowOnlyVisibleFeaturesCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Show only features visible within a map", nullptr));
        mComposerMapLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Linked map", nullptr));
        mIntersectAtlasCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Show only features intersecting atlas feature", nullptr));
        mFeatureFilterCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Filter with", nullptr));
        mFeatureFilterButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "\342\200\246", nullptr));
        groupBox_6->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Appearance", nullptr));
        label_11->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Wrap text on", nullptr));
        mAdvancedCustomizationButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Advanced Customization\342\200\246", nullptr));
        label_10->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Background color", nullptr));
        label_9->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Empty tables", nullptr));
        mDrawEmptyCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Show empty rows", nullptr));
        label_12->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Oversized text", nullptr));
        mBackgroundColorButton->setText(QString());
        label_7->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Display header", nullptr));
        mMarginSpinBox->setSuffix(QApplication::translate("QgsLayoutAttributeTableWidgetBase", " mm", nullptr));
        mEmptyMessageLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Message to display", nullptr));
        mMarginLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Cell margins", nullptr));
        mUseConditionalStylingCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Apply layer conditional styling colors", nullptr));
        mShowGridGroupCheckBox->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Show Grid", nullptr));
        mGridStrokeWidthLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Line width", nullptr));
        mGridStrokeWidthSpinBox->setSuffix(QApplication::translate("QgsLayoutAttributeTableWidgetBase", " mm", nullptr));
        label_6->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Color", nullptr));
        mGridColorButton->setText(QString());
        mDrawHorizontalGrid->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Draw horizontal lines", nullptr));
        mDrawVerticalGrid->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Draw vertical lines", nullptr));
        groupBox_3->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Fonts and Text Styling", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Table Heading", nullptr));
        label_2->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Alignment", nullptr));
        label_5->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Font", nullptr));
        mHeaderFontToolButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Heading Font", nullptr));
        groupBox_4->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Table Contents", nullptr));
        lblContentsFont->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Font", nullptr));
        mContentFontToolButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Contents Font", nullptr));
        frameGroupBox->setTitle(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Frames", nullptr));
        mResizeModeLabel->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Resize mode", nullptr));
        mAddFramePushButton->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Add Frame", nullptr));
        mEmptyFrameCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Don't export page if frame is empty", nullptr));
        mHideEmptyBgCheckBox->setText(QApplication::translate("QgsLayoutAttributeTableWidgetBase", "Don't draw background if frame is empty", nullptr));
    } // retranslateUi
