...
public:
    ...
    {
        QgsGradientColorRampDialogBase->setWindowTitle(QApplication::translate("QgsGradientColorRampDialogBase", "Gradient Color Ramp", nullptr));
        label->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Color &1", nullptr));
        btnColor1->setText(QString());
        label_2->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Color &2", nullptr));
        btnColor2->setText(QString());
        label_3->setText(QApplication::translate("QgsGradientColorRampDialogBase", "&Type", nullptr));
        groupBox_2->setTitle(QApplication::translate("QgsGradientColorRampDialogBase", "Gradient Stop", nullptr));
        label_4->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Relative &position", nullptr));
        mPositionSpinBox->setSuffix(QApplication::translate("QgsGradientColorRampDialogBase", " %", nullptr));
        mDeleteStopButton->setText(QApplication::translate("QgsGradientColorRampDialogBase", "&Delete Stop", nullptr));
        mPlotGroupBox->setTitle(QApplication::translate("QgsGradientColorRampDialogBase", "Plot", nullptr));
        mPlotHueCheckbox->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Hue", nullptr));
        mPlotSaturationCheckbox->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Saturation", nullptr));
        mPlotLightnessCheckbox->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Lightness", nullptr));
        mPlotAlphaCheckbox->setText(QApplication::translate("QgsGradientColorRampDialogBase", "Opacity", nullptr));
        btnInformation->setText(QApplication::translate("QgsGradientColorRampDialogBase", "&Information", nullptr));
    } // retranslateUi
